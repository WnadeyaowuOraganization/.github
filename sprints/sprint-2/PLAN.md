...
> 更新时间：2026-05-10（排程经理第1129轮；#3199已提PR#4577；cc-test-env.sh Controller诊断；smoke选择器优化）
> ⚠️ needs-prototype冻结、Master Issue不出现在本表；指派前请用 `gh issue view #N` 确认标签
> 注意：本表与GitHub Issue编号一致，无需转换

| # | Issue | 优先级 | 模块 | 说明 | 启动 |
|---|-------|--------|------|------|------|
| 1 | ~~#3200~~ | P1 | backend | 计划变更管理 — 版本对比+影响分析+审批流（project-plan [8/10]） | ✅ 已指派 kimi1 |
| ~~3~~ | ~~#3198~~ | P1 | frontend | 项目主计划页面 — 条线视图+甘特图（project-plan [6/10]） | ✅ 已提 PR #4572 |
| 5 | ~~#2636~~ | P1 | frontend | 品牌中心·数字人 — 数字分身+声音克隆管理页面 [4/7] | ~~✅ 已提 PR #4578 MERGED~~ |
| 6 | #2640 | P1 | backend | 品牌中心·视频裂变 — 视频裂变服务+素材包管理API [1/3] | ✅ 已指派 kimi5 |
| 7 | ~~#2641~~ | P1 | frontend | 品牌中心·视频裂变 — 视频裂变工作台+素材包审批页面 [2/3] | ✅ 已指派 kimi2 |
| 8 | ~~#2645~~ | P1 | pipeline | 品牌中心·舆情监控 — 品牌舆情采集+情感分析+告警Pipeline [1/2] | ✅ 已指派 kimi3 |
| 9 | ~~#2646~~ | P1 | fullstack | 品牌中心·舆情监控 — 品牌舆情仪表盘+提及列表+周报 [2/2] | ✅ 已指派 kimi4 |
| 10 | ~~#2654~~ | P1 | pipeline | 品牌中心·内容自动化 — AI海报自动生成Pipeline [2/5] | ✅ 已指派 kimi6 |
| 11 | #2657 | P1 | fullstack | 品牌中心·内容自动化 — 内容日历+海报/文章审批工作台+发布管理 [5/5] | ✅ |
| 12 | #2644 | P1 | fullstack | 品牌中心·员工代言 — 内容池管理+员工分享看板+H5分享页 [2/2] | ✅ |
| 13 | #2660 | P1 | frontend | 色卡配色器 — 交互式配色面板+实时预览 [2/4] | ✅ |
| 14 | #2740 | P1 | frontend | 商战情报中台·分发 — 移动端情报快览小程序 [5/8] | ✅ |
| 15 | #3116 | P1 | pipeline | 经销商发现 — 评分模型增加「专注度检验」维度 | ✅ |
| 16 | #2413 | P2 | pipeline | 竞品出口客户反向采集脚本 — 凯奇/奇特乐/永浪海外买家（海外客户发现 [2/3]） | ✅ |
| 17 | #2451 | P2 | backend | 竞品中标项目名称分词 → 补充keyword_pool搜索盲区（[5/38]） | ✅ |
