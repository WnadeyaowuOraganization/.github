...
> 更新时间：2026-05-05（排程经理第817轮；新增20个Todo #1838/#1842/#2100/#2101/#2133/#2144/#2147/#2200/#2322~#2365，Todo 49项）
> ⚠️ needs-prototype冻结、Master Issue不出现在本表
> 注意：本表与GitHub Issue编号一致，无需转换

| # | Issue | 优先级 | 模块 | 说明 | 启动 |
|---|-------|--------|------|------|------|
| 1 | #1616 | P1 | chat | 每日群聊摘要服务 — 定时+即时双模式（kimi3已接，PR#4454） | ⏳ PR#4454 单测FAIL |
| 2 | ~~#1612~~ | P2 | chat | ~~业务场景自动分类引擎~~ → **PR#4457 OPEN** | ⏳ In Progress |
| 3 | #2021 | P2 | approval | 报销费控模块接入审批流 — 报销提交自动发起审批 | ✅ |
| 4 | #1686 | P2 | backend | 报销费控新增项目费用关联+财务报表导出+供应商联动 | ✅ |
| 5 | #1698 | P2 | backend | 提成绩效新增提成计算引擎API — 阶梯计算+绩效系数+批量计算 | ✅ |
| 6 | #2069 | P2 | auth | 企微OAuth扫码登录后端API | ✅ |
| 7 | #1666 | P2 | biz-enablement | AI参数问答助手API — 结构化数据精准回答+投标辅助填表 | ✅ |
| 8 | #2132 | P2 | backend | RBAC功能权限管控 — 10个新模块+功能发布开关+权限校验 | ✅ |
| 9 | #2070 | P1 | hr | 培训管理菜单权限SQL — 培训管理5个二级菜单+按钮权限 | ✅ |
| 10 | #2071 | P1 | hr | 培训管理后端Controller API — 培训计划/课程/记录/证书/评估接口 | ✅ |
| 11 | #2072 | P1 | hr | 培训管理Entity+Mapper+Service — 培训计划/课程/记录/证书/评估 | ✅ |
| 12 | #2073 | P2 | hr | 人事管理菜单和权限SQL — 人事管理菜单+按钮权限配置 | ✅ |
| 13 | #1838 | P2 | design-ai | 批量方案变体生成 — 输入约束→AI生成多个布局方案 | ✅ |
| 14 | #1842 | P2 | design-ai | 产品资源开放体系 — D1素材库2D/3D/SKP下载API | ✅ |
| 15 | #2100 | P2 | backend | AI工单智能分派 — 自动推荐最优处理人 | ✅ |
| 16 | #2101 | P2 | backend | AI预测性维护 — 故障预测+预防性维护计划 | ✅ |
| 17 | #2133 | P1 | backend | 企微OA能力扩展 — 审批+日程+会议+智能表格+模板卡片 | ✅ |
| 18 | #2144 | P2 | brand | AI辅助翻译 — Qwen3中英互译 | ✅ |
| 19 | #2147 | P2 | pipeline | G7e工具链部署 — PRD Generator + Acceptance Tester | ✅ |
| 20 | #2200 | P1 | brand | G7e MediaX SDK — 抖音/B站/小红书/YouTube发布 | ✅ |
...
| 05-05 | kimi2 | ~~#1612~~ | chat | P2 | **Done** | 业务场景自动分类引擎 — PR #4457 OPEN |
...
| kimi2 | #1612 | chat | P2 | 业务场景自动分类引擎 | ⏳ PR#4457 OPEN等待合并 |
| kimi3 | #1616 | chat | P1 | 每日群聊摘要服务 | ⏳ PR#4454 单测FAIL |

> **2 CC运行中**（kimi2等待合并/kimi3单测FAIL）；kimi1空闲；Pool 14/15空闲；Todo 22项
| kimi3 | #1616 | chat | P1 | 每日群聊摘要服务 | ⏳ PR#4454 单测FAIL |

> **1 CC运行中**（pool 14/15空闲）；kimi1/#1843 MERGED✅；kimi2 PR#4457 OPEN；#1616单测FAIL已通知研发经理

> **3 CC运行中**（pool 12/15空闲）；#1616单测FAIL已通知研发经理
