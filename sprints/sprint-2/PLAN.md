...
| kimi3 | #1499 | Phase4 | mine | 经销商数据模型(dealer表+覆盖区域+绩效指标) PR#3882 CI中 |
| kimi4 | #1502 | Phase3 | mine | 竞品活跃度统计视图(按竞品×区域×项目类型汇总) |
| kimi6 | #2236 | Phase3 | mine | 竞品追踪分析页(热力图+趋势+排行榜) |
| kimi19 | #2398 | Tier-A | mine | 竞品中标记录采集 PR#3884 CI重跑中 |
...
| kimi19 | #2398 | Tier-A | mine | ~~竞品中标记录采集(后端+前端)~~ | ~~PR#3884 轮询中~~ |
...
| kimi19 | #2398 | Tier-A | mine | 竞品中标记录采集(后端+前端) | PR#3884 CI重跑中 |
