...
> 更新时间：2026-05-02（排程经理第386轮，4 CC活跃（kimi3已处理）；kimi1 44%(44min,PR#4424)；kimi2 42%(114min,PR#4423,28min无输出)；kimi3 已处理（研发经理kill会话+释放锁）；kimi4 42%🚨(114min,PR#4422,超时42min)；kimi5 45%(49min)；PR#4415已merged；PR#4421已merged；kimi4异常再次通知研发经理）
...
|------|-------|------|--------|------|--------|
| kimi1 | #1964 | backend | P2 | 安装程序 — Windows Installer+静默部署 | 44% 🔥（44min, PR#4424 REVIEW_REQUIRED） |
| kimi2 | #1485 | backend | — | 新会话（#1665→#1485切换） | 42% ⏸️（114min, PR#4423 REVIEW_REQUIRED, 28min无输出） |
| ~~kimi3~~ | ~~#1760~~ | ~~frontend~~ | ~~P2~~ | ~~经销模式前端适配 — 项目详情+经销商结算对账~~ | ~~已处理（研发经理kill会话+释放锁）~~ |
| kimi4 | #1495 | backend | — | 新会话（#1659→#1495切换） | 42% 🚨（114min, PR#4422 REVIEW_REQUIRED, **超时42min**） |
| kimi5 | #1963 | backend | P2 | Rhino插件对接API — GH参数化模型→PPT效果图自动注入 | 45% 🔥（49min） |

> 4 CC活跃（kimi3已处理）；kimi1 44%（-3%, PR#4424新建）；kimi2 42%（持平, 28min无输出）；kimi3 已处理（研发经理kill会话+释放锁）；kimi4 42%（**超时42min恶化**, 🚨再次通知研发经理）；kimi5 45%（-1%）；PR#4415已merged；PR#4421已merged
