...
|------|-------|------|--------|------|
| kimi3 | #1613 | wechat | P1 | 数据安全分级与访问控制（50%） |
| kimi4 | #1614 | wechat | P1 | PII自动脱敏服务（50%） |
| kimi5 | #1873 | bidding | P1 | 分级超时升级机制（49%，沉默24.5分） |
...
| kimi | Issue | PR | 合并时间 |
|------|-------|----|----|
| kimi1 | ~~#1594~~ | #4179 | 05:28:06 UTC |
| kimi2 | ~~#1599~~ | #4180 | 05:40:07 UTC |
