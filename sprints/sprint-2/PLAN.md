...
|------|-------|------|--------|------|--------|
| kimi2 | #2756 | backend | P1 | 客户生命周期-通知规则管理API | PR#4241冲突解决中 |
| kimi7 | #2271 | backend | P1 | D3材质标注面板-构件选中+色块+3D预览 | E2E测试中 |
| kimi5 | #2268 | backend | P1 | D3材质-批量智能标注+模板+配色方案 | 恢复派发 |

**暂停（等空位恢复）：** kimi1/#2265, kimi4/#2264, kimi6/#2712
...
| kimi2 | #2756 | #4241 | ⚠️ 冲突 | CONFLICTING，已注入rebase |
