...
| kimi5 | #1865 | P1 | pipeline | [D3-AI] 设计师知识画像与自适应教学（ITS学员模型） | PR#3765⏳ 等待CI merge |
...
| kimi3 | #2700 | P1 | pipeline | [商战情报中台] 早期项目信号检测 | PR#3763⏳ 等待CI merge |
...
| kimi4 | #3727 | P2 | frontend | 执行管理v2.0 [22/22] Tab8 售后质保前端 | 06:33 启动（#3725✅已解锁）|
