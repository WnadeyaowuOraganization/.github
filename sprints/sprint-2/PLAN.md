...
> 更新时间：2026-04-27 19:10（第12轮刷新，排除needs-prototype冻结后仅剩6个可用Issue）
> ⚠️ needs-prototype冻结（共15个）：#2585/#1573/#2222/#2288/#2277/#1466/#2223/#2219/#2221/#2217/#2220/#2218/#2278/#2389/#2390
> 排除：needs-prototype 标签、Master Issue、已派/已完成

| 序号 | Issue | 优先级 | 模块 | effort | 说明 | 启动 |
|------|-------|--------|------|--------|------|------|
| 116 | #2293 | P2 | budget | medium | 保证金台账页面 [7/32] | ✅ |
| 117 | #2539 | P2 | fullstack | medium | 项目通讯录增强 — 外部干系人+RACI矩阵 [18/18] | ✅ |
| 118 | #3106 | P2 | fullstack | medium | 发货管理（国贸专用）— 装箱单+报关+海运空运 | ✅ |
| 119 | #3107 | P2 | fullstack | medium | 出口单据管理 — CI/PL/BL/CO/FormE自动生成 | ✅ |
| 120 | #3111 | P2 | backend | medium | 汇率管理+利润自动计算 — 报价锁汇+收款汇率 | ✅ |
| 121 | #2639 | P2 | backend | low | 数字人+声音克隆平台选型对比评估（文档）[7/7] | ✅ |
...
|------|-------|------|--------|------|--------|
| kimi1 | #2639 | backend | P2 | 数字人+声音克隆平台选型评估文档（建议#121，最后1个） | 编码中 |
| kimi2 | #3111 | backend | P2 | 汇率管理+利润自动计算（建议#120） | 编码中 |

**2/2 并发在线。建议表#116-#121全部已派，#121为最后一个可用Issue。**
