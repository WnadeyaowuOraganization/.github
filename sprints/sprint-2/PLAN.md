...
| # | Issue | 优先级 | 模块 | 说明 | 启动 |
|---|-------|--------|------|------|------|
| 1 | #2747 | P1 | backend | 客户生命周期[4/12] 客户满意度回访提醒 — 验收后自动创建回访任务 | ✅ |
| 2 | #2737 | P1 | backend | 商战情报中台·分发[2/8] 企微交互式查询指令 | ✅ |
| 3 | #4124 | P1 | fullstack | 国贸专属页 — 壳架构+5Tab容器+菜单入口（kimi4已接） | 🔥 |
| 4 | #3188 | P1 | fullstack | 回款资料[4/7] 企业信息库 — 万德常用信息维护+一键填充到回款表单（kimi1空闲） | ✅ |
...
| 7 | #2738 | P1 | backend | 商战情报中台·分发[3/8] 邮件订阅与定时报告（kimi3空闲） | ✅ |
...
| kimi3 | — | — | — | 空闲（#3185 PR#4087已合并，Issue关闭） | — |
