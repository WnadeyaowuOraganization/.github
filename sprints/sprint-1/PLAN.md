...
## 指派建议（最近20个）
> 🔄 **更新：2026-04-08 18:40 UTC | 净容量 9/15，6槽空 | 质保售后#1742/#1744/#1746新解锁 | 执行管理#2122解锁 | D3-v2.0 P0待启动**
...
| #2122 | P0 | backend | [执行管理] AI回款风险预警 — 智能分析+企微推送+三级预警 | ✅ #2124 CLOSED解锁 |
...
| #1746 | P1 | frontend | [质保售后] 售后工单管理主页面 — 看板+列表+筛选+详情侧滑 | ✅ #2109 CLOSED解锁 |
| #1742 | P1 | frontend | [质保] 质保台账管理页面 — 台账列表+到期预警+设备明细 | ✅ #2110 CLOSED解锁 |
| #1744 | P1 | frontend | [质保售后] 质保台账管理页面v2 — 台账列表+到期预警+二维码 | ✅ #2110 CLOSED解锁 |
...
| #2094 | P2 | backend | [执行管理] 验收模块联动 — 触发质保+回款+BOM对照 | ✅ #2098/#2124/#2086 CLOSED解锁 |
