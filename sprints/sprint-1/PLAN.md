...
| ~~kimi2~~ | ~~#1589~~ | P2 | fullstack | ~~[预算][27/32] 历史成本基准查询API+前端页面~~ | PR#3802✅merged 16:13（⚠️缺JUnit/API spec，auto-merge第2次）| ~~Done~~ |
...
| ~~kimi3~~ | ~~#2291~~ | P2 | frontend | ~~[预算][18/32] 借款管控增强页面（补做）~~ | PR#3801✅merged 07:53（E2E+截图✅，UPDATE菜单13003✅）| ~~Done~~ |
...
| ~~kimi2~~ | ~~#2357~~ | P1 | frontend | ~~[资金闭环-P1][11/17] 应付账款管理页面~~ | PR#3807✅merged 17:26 | ~~Done~~ |
...
| ~~kimi1~~ | ~~#3814~~ | P1 | frontend | ~~[Sprint-1修复] CRM 经销商新增/编辑功能实现~~ | PR#3816✅merged 2026-04-16T21:15Z（经理手动合并） |
| **生产部署** | **build-deploy** | — | devops | **E2E守门员✅→构建脚本修复→Lightsail部署** | E2E gate通过(4m28s) #3815✅merged；#3817 FETCH_HEAD修复 deployed |
| kimi2 | #1691 | P1 | backend | [执行管理] 项目利润仪表盘API+排行榜+复盘报告 | 2026-04-16T21:03启动 |
| kimi3 | #2387 | P1 | frontend | [执行管理] 利润预估页面+商机详情Tab+预估vs实际 | 2026-04-16T21:03启动 |
| kimi4 | #2083 | P1 | fullstack | [执行管理] 开票管理 — 申请/审核/台账/发票跟踪+回款 | 2026-04-16T21:03启动 |
| ~~kimi5~~ | ~~#1718~~ | P1 | frontend | ~~[执行管理] 利润仪表盘页面+趋势图+对比图+列表~~ | PR#3820 创建 2026-04-16T21:28，pr-test 排队中 |
...
| kimi2 | #1691 | P1 | backend | [执行管理] 项目利润仪表盘API+排行榜+复盘报告（会话崩溃T10-T13重启） | 2026-04-17重启 |
