...
> 更新时间：2026-05-02（排程经理第396轮，5 CC已启动；前10条有needs-prototype已替换；PR#4415/4421/4422/4423/4424已merged）
...
|------|-------|------|--------|------|--------|
| kimi1 | #1496 | backend | P2 | NBO行动推荐生成 — Today's Top 3行动 | 启动中 |
| kimi2 | #1497 | backend | P2 | NBO评分引擎 — 项目适配度×意图×赢率综合评分 | 启动中 |
| kimi3 | #1538 | budget | P2 | D3造价回填接口 — D3设计完成后自动写入设备科目预算 | 启动中 |
| kimi4 | #1539 | budget | P2 | 历史基准自动积累 — 项目关闭时自动更新成本基准库 | 启动中 |
| kimi5 | #1590 | budget | P2 | 项目成本复盘报告自动生成 | 启动中 |

> **5 CC活跃，池子已满**；05-02 14:02 清空后立刻补派5个Issue；PR#4415/4421/4422/4423/4424已merged
