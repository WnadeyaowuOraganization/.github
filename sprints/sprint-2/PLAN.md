...
> 更新时间：2026-04-30（排程经理第180轮，#4060/#4095/#2220 Done；kimi1空闲待补）
> ⚠️ needs-prototype冻结、Master Issue不出现在本表
> 注意：本表与GitHub Issue编号一致，无需转换

| # | Issue | 优先级 | 模块 | 说明 | 启动 |
|---|-------|--------|------|------|------|
| 1 | ~~#3185~~ | P0 | frontend | ~~全过程资料[1/13] 全阶段资料完成度看板 — 全项目×全阶段文件完整度+法规缺失预警+催收入口（kimi3已完成，PR#4087已于04-22合并）~~ | ✅ |
| 2 | #4124 | P1 | fullstack | 国贸专属页 — 壳架构+5Tab容器+菜单入口（kimi4已接） | 🔥 |
| 3 | #3188 | P1 | fullstack | 回款资料[4/7] 企业信息库 — 万德常用信息维护+一键填充到回款表单 | ✅ |
