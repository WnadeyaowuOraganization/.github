...
| kimi2 | #2141 | backend | P1 | 素材批量迁移工具 — S3/NAS/PPT拆页+AI自动打标签 | PR #4405 E2E queued>10min 等runner |
| kimi3 | — | — | — | 空闲（#2162 PR#4404已合并） | ✅ |
| kimi4 | #4124 | fullstack | P1 | 国贸专属页 — 壳架构+5Tab容器+菜单入口 | PR #4376 质量预检❌（其余全✅） |
| kimi5 | #3570 | frontend | P1 | 关系网络Tab组件测试与截图验证（#3545-followup） | PR #4388 质量预检❌ E2E pending |
