...
| kimi5 | #3588 | P2 | frontend | 产品门户 [9/10] H5移动端适配（产品目录/详情/备件三页） PR#3753⏳ | 04:23 启动 |
...
| kimi1 | #3552 | P0 | backend | [矿场修复] 6个管线脚本表名不兼容修复（Python脚本wdpp_前缀） | 04:26 启动 |
| ~~kimi2~~ | ~~#3717~~ | ~~P0~~ | ~~frontend~~ | ~~执行管理v2.0 [12/22] Tab3合同与交付（合同状态+交付节点+发货跟踪）~~ PR#3747✅merged 2026-04-16 03:18 | ~~Done~~ |
| kimi2 | #3721 | P0 | backend | 执行管理v2.0 [16/22] 工艺路线+设备进度矩阵API PR#3754⏳ | 03:26 启动 |
