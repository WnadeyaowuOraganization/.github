...
> 更新时间：2026-05-11（研发经理第1轮；8 CC批量指派；7幽灵In Progress修复；商战情报中台行业信息+项目矿场8 Issue启动）
...
> 更新时间：2026-05-11（排程经理第1140轮；Jenkinsfile修复#407/#410等分支不存在checkout失败；指派建议表耗尽，仅#2457/#2490可立即指派，其余65条被#4065/#4091阻塞或needs-prototype冻结）
> ⚠️ needs-prototype冻结、Master Issue不出现在本表；指派前请用 `gh issue view #N` 确认标签
> 注意：本表与GitHub Issue编号一致，无需转换

| # | Issue | 优先级 | 模块 | 说明 | 启动 |
|---|-------|--------|------|------|------|
| 1 | #2457 | P2 | design-ai | 设计模型训练 — 竞品T1级6家效果图采集 LoRA-B训练素材 [2/14] | ✅ |
| 2 | #2490 | P2 | design-ai | 设计模型训练 — LoRA增量训练机制 新品素材自动入库 [9/14] | ✅ |
| 3 | ~~#2489~~ | P2 | design-ai | 设计模型训练 — 批量渲染引擎 [8/14] | ~~⏳ 依赖 #4097 OPEN~~ |
| 4 | ~~#2496~~ | P2 | pipeline | 竞品情报 Phase5 — T3级30家补充采集 | ~~⏳ 依赖 #4065 OPEN~~ |
| 5 | ~~#2648~~ | P2 | fullstack | 品牌中心·SEO [2/2] 前端 — SEO内容管理页面+排名看板 | ~~⏳ 依赖 #4091 OPEN~~ |
| 6 | ~~#2649~~ | P2 | backend | 品牌中心·思想领导力 — LinkedIn Thought Leader Ads | ~~⏳ 依赖 #4091 OPEN~~ |
| 7 | ~~#2655~~ | P1 | pipeline | 品牌中心·内容自动化 [3/5] — 文章选题引擎 | ~~⏳ 依赖 #4091+#2648 OPEN~~ |
| 8 | ~~#2656~~ | P1 | pipeline | 品牌中心·内容自动化 [4/5] — 文章AI初稿生成 | ~~⏳ 依赖 #4091 OPEN~~ |
| 9 | ~~#2662~~ | P2 | frontend | 色卡配色器 [4/4] — 需求表预览+导出+审批 | ~~⏳ 依赖 #4198 OPEN~~ |
| 10 | ~~#2705~~ | P2 | bidding | 商战情报中台·项目矿场 [10/10] — 投标利润预测模型 | ~~⏳ 依赖 #4065 OPEN~~ |
| 11 | ~~#2706~~ | P2 | customer-intelligence | 商战情报中台·客户雷达 [1/10] — ICP理想客户画像 | ~~⏳ 依赖 #4065 OPEN~~ |
| 12 | ~~#2707~~ | P2 | customer-intelligence | 商战情报中台·客户雷达 [2/10] — ICP自动评分引擎 | ~~⏳ 依赖 #4065 OPEN~~ |
| 13 | ~~#2708~~ | P2 | customer-intelligence | 商战情报中台·客户雷达 [3/10] — 多源意图信号采集 | ~~⏳ 依赖 #4065 OPEN~~ |
| 14 | ~~#2709~~ | P2 | customer-intelligence | 商战情报中台·客户雷达 [4/10] — 客户购买阶段预测 | ~~⏳ 依赖 #4065 OPEN~~ |
| 15 | ~~#2711~~ | P2 | customer-intelligence | 商战情报中台·客户雷达 [6/10] — 客户雷达实时看板 | ~~⏳ 依赖 #4065 OPEN~~ |
| 16 | ~~#2714~~ | P2 | customer-intelligence | 商战情报中台·客户雷达 [9/10] — 客户流失预警模型 | ~~⏳ 依赖 #4065 OPEN~~ |
| 17 | ~~#2715~~ | P2 | customer-intelligence | 商战情报中台·客户雷达 [10/10] — ABM目标客户清单编排 | ~~⏳ 依赖 #4065 OPEN~~ |
| 18 | ~~#2716~~ | P2 | backend | 商战情报中台·竞品情报 [1/10] — 竞品知识图谱 | ~~⏳ 依赖 #4065 OPEN~~ |
| 19 | ~~#2717~~ | P2 | backend | 商战情报中台·竞品情报 [2/10] — AI事实卡片自动更新 | ~~⏳ 依赖 #4065 OPEN~~ |
| 20 | ~~#2494~~ | P2 | pipeline | 竞品情报-P0 Phase3 — T1级6家深度采集 | ~~⏳ PR #4623 OPEN 等待 merge~~ |
...
| #2489 | ⏳ 依赖 #4097 OPEN | Todo（阻塞） |
| #2496 | ⏳ 依赖 #4065 OPEN（全部竞品客户雷达Issue共用） | Todo（阻塞） |
| #2648/#2649/#2655/#2656 | ⏳ 依赖 #4091 OPEN（品牌中心SEO/内容自动化） | Todo（阻塞） |
| #2662 | ⏳ 依赖 #4198 OPEN | Todo（阻塞） |
| #2705~#2717 | ⏳ 依赖 #4065 OPEN（商战情报中台客户雷达+竞品情报） | Todo（阻塞） |
| #2457 | ✅ 可立即指派（无 blocker） | ✅ |
| #2490 | ✅ 可立即指派（无 blocker） | ✅ |
...
| #2332 | kimi3 CC工作中 | In Progress |
| #2336 | ✅ PR #4541 OPEN | PR |
| #2360 | ✅ PR #4546 OPEN | PR |
| #2365 | kimi1 CC工作中 | In Progress |
| #3154 | kimi4 CC工作中 | In Progress |
...
| #3199 | ✅ PR #4577 OPEN（等待merge） | PR |
| #3195 | 已指派 kimi2 | In Progress |
| #2020 | ✅ PR #4559 MERGED | Done |
| #2313 | ✅ PR #4555 MERGED | Done |
| #2331 | ✅ PR #4554 MERGED | Done |
| #2414 | 已指派 kimi7 | In Progress |
| #2433 | ✅ PR #4556 MERGED | Done |
| #2443 | ✅ PR #4558 MERGED | Done |
| #2448 | ✅ PR #4557 MERGED | Done |
...
| #1625 | ✅ PR 已MERGED | Done |
| #1856 | ✅ PR 已MERGED | Done |
| #2052 | ✅ PR 已MERGED | Done |
| #2065 | ✅ PR 已MERGED | Done |
| #2105 | ✅ PR 已MERGED | Done |
| #2148 | ✅ PR 已MERGED | Done |
| #2204 | ✅ PR 已MERGED | Done |
| #2262 | ✅ PR 已MERGED | Done |
| #2287 | ✅ PR 已MERGED | Done |
| #2354 | ✅ PR 已MERGED | Done |
| #2356 | ✅ PR 已MERGED | Done |
| #2510 | ✅ PR 已MERGED | Done |
| #3134 | ✅ PR 已MERGED | Done |
| #3179 | ✅ PR 已MERGED | Done |
| #3183 | ✅ PR 已MERGED | Done |
| #3191 | ✅ PR 已MERGED | Done |
| #3292 | ✅ PR 已MERGED | Done |
| #4021 | ⛔ Master Issue（导航用，禁止出现在建议表） | Done |
...
| ~~kimi2~~ | ~~#2360~~ | ~~frontend~~ | ~~P1~~ | ~~设计变更通知+确认页面~~ | ~~✅ PR #4546 MERGED 05-09~~ |
| ~~kimi5~~ | ~~#2691~~ | ~~fullstack~~ | ~~P1~~ | ~~竞品产品对比矩阵~~ | ~~✅ PR #4547 MERGED 05-09~~ |
| ~~kimi5~~ | ~~#2746~~ | ~~backend~~ | ~~P2~~ | ~~赢/丢单复盘触发~~ | ~~✅ PR #4548 MERGED 05-09~~ |
| ~~kimi2~~ | ~~#2529~~ | ~~backend~~ | ~~P2~~ | ~~公告板Service CRUD+@提及解析+企微通知~~ | ~~✅ PR #4549 MERGED 05-09~~ |
| ~~kimi2~~ | ~~#2531~~ | ~~frontend~~ | ~~P2~~ | ~~项目详情页·公告板Tab~~ | ~~✅ PR #4550 MERGED~~ |
...
| 05-09 | kimi1 | ~~#2115~~ | backend | medium | ~~Done~~ | G7e采集自动化 — PR #4543 MERGED ✅ |
...
| 05-09 | kimi7 | #3217 | frontend | P2 | In Progress | 预算区域管理页面 — 区域列表+招标文件导入+手动添加 [7/10] |
...
## ⚠️ 研发经理 → 排程经理：Issue 队列告急

**时间**: 2026-05-10

**当前状态**: 8/8 kimi 中 7 个工作中，1 个空闲（kimi8）。

**问题**: 指派建议表已耗尽。当前所有未指派 Issue 均有阻塞依赖：

| Issue | 优先级 | 阻塞原因 |
|-------|--------|---------|
| #2371 | P1 | blocked-by #1318(数据库) + #1320(T1数据) |
| #3198 | P1 | blocked-by [5/10] #3197(计划管理REST API) |
| #2413 | P2 | blocked-by #2424(browser_client) + #2425(search_client) |
