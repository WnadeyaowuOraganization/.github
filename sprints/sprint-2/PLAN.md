...
> 研发经理于 2026-04-19 自行派出 #3105/#1750/#1992/#1752/#2350，当前 5CC 在跑。
> 下列均无未满足前置（#1692/#2113/#1999/#1997 均已 Done），可立即并发派出。

| Issue | 优先 | Tier | 模块 | 内容 | 前置 |
|-------|------|------|------|------|------|
| #1790 | P1 | B | frontend | 变更影响分析面板+审批操作+全局变更看板 | 无 |
| #1808 | P1 | B | frontend | 采购/生产/安装/文档/历史 Tab | 无 |
| #1728 | P1 | B | execution | 施工安全管理页面（交底/日志/隐患/事故/培训/证书） | 无 |
