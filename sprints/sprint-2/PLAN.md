...
> 更新时间：2026-05-05（排程经理第820轮；kimi2释放，#1612 PR#4457 MERGED；Todo 38项）
...
| 5 | #1666 | P2 | biz-enablement | AI参数问答助手API — 结构化数据精准回答+投标辅助填表 | ✅ |
| 6 | #2132 | P2 | backend | RBAC功能权限管控 — 10个新模块+功能发布开关+权限校验 | ✅ |
| 7 | #2070 | P1 | hr | 培训管理菜单权限SQL — 培训管理5个二级菜单+按钮权限 | ✅ |
| 8 | #2071 | P1 | hr | 培训管理后端Controller API — 培训计划/课程/记录/证书/评估接口 | ✅ |
| 9 | #2072 | P1 | hr | 培训管理Entity+Mapper+Service — 培训计划/课程/记录+证书+评估 | ✅ |
| 10 | #2073 | P2 | hr | 人事管理菜单和权限SQL — 人事管理菜单+按钮权限配置 | ✅ |
| 11 | #1838 | P2 | design-ai | 批量方案变体生成 — 输入约束→AI生成多个布局方案 | ✅ |
| 12 | #1842 | P2 | design-ai | 产品资源开放体系 — D1素材库2D/3D/SKP下载API | ✅ |
| 13 | #2100 | P2 | backend | AI工单智能分派 — 自动推荐最优处理人 | ✅ |
| 14 | #2101 | P2 | backend | AI预测性维护 — 故障预测+预防性维护计划 | ✅ |
| 15 | #2133 | P1 | backend | 企微OA能力扩展 — 审批+日程+会议+智能表格+模板卡片 | ✅ |
| 16 | #2144 | P2 | brand | AI辅助翻译 — Qwen3中英互译 | ✅ |
| 17 | #2147 | P2 | pipeline | G7e工具链部署 — PRD Generator + Acceptance Tester | ✅ |
| 18 | #2200 | P1 | brand | G7e MediaX SDK — 抖音/B站/小红书/YouTube发布 | ✅ |
| 19 | #2166 | P1 | backend | AI图生图API — 图片分析+出图引擎（新入Todo） | ✅ |
| 20 | #2420 | P1 | backend | Agent基建 CLAUDE.md + docs/agent-guide.md（新入Todo） | ✅ |
