...
## 指派建议（最近20个）
> 🔴 **[P0][项目挖掘改版] 用户插队 2026-04-08 19:26 UTC | #3451/#3453/#3454/#3455 Plan→Todo插队；14/15(1槽空闲)；prefetch已推dev**
...
| Issue | 优先 | 模块 | 内容 | 启动 |
|-------|------|------|------|------|
| #3451 | 🔴P0插队 | fullstack | [项目挖掘改版][3/8] 多信源链接展示 — 支持多条信源URL列表显示 | ✅ 独立 |
| #3453 | 🔴P0插队 | frontend | [项目挖掘改版][5/8] 统一表格视图+设备招标倒计时 | ✅ 独立 |
| #3454 | 🔴P0插队 | fullstack | [项目挖掘改版][6/8] 竞对动态Tab增强 — 竞品中标+盲区发现 | ✅ 独立 |
| #3455 | 🔴P0插队 | fullstack | [项目挖掘改版][7/8] 项目研判卡 — AI计算关联度+可行动建议 | ⏳ 建议等3/8完成后并行 |
...
| #1518 | P1 | backend | [业务运营中心][7/8] 业务数据仪表盘 — 业务KPI统计分析 | ✅ #1520解锁 |
| #1746 | P1 | frontend | [质保售后] 售后工单管理主页面 — 看板+列表+筛选 | ✅ #2109 CLOSED |
| #1742 | P1 | frontend | [质保] 质保台账管理页面 — 台账+到期预警+设备明细 | ✅ #2110 CLOSED |
...
| kimi3 | #3458 | Jump | fullstack | [全球项目矿场v3.0] 9项功能统一改版（**Claude Max Sonnet**） | 重启中 |
