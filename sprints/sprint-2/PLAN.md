...
> 更新时间：2026-05-02（排程经理第370轮，kimi1 45%；kimi3 63%；kimi5 43%；kimi2/4短时暂停）
...
|------|-------|------|--------|------|--------|
| kimi1 | #1490 | backend | P2 | 个人周报/团队月报自动生成+推送 | 45% 🔥（533min） |
| kimi2 | #1784 | backend | — | 新会话（已重启） | 15% ⏸️（17min无输出） |
| kimi3 | #1760 | frontend | P2 | 经销模式前端适配 — 项目详情+经销商结算对账 | 63% 🔥（PR#4418 REVIEW_REQUIRED） |
| kimi4 | #1679 | backend | — | 新会话（#1689→#1679切换） | 32% ⏸️（14min无输出） |
| kimi5 | #1948 | backend | — | 新CC | 43% 🔥 |

> kimi1 45%推进中；kimi3 63%；kimi5 43%；kimi2/4短时暂停观察
