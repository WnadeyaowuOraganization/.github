...
> 研发经理维护。指派时新增行，完成后在内容列加删除线，看板状态改为 ~~Done~~。
...
| kimi16 | #1876 | — | backend | 商务48小时反馈机制+分级升级 | In Progress |
| kimi16 | #2461 | — | backend | 合同管理建表 | In Progress |
| kimi1 | #1700 | — | backend | 提成绩效5张表 | In Progress |
| kimi15 | #2159 | — | backend | 质保售后12张表建表 | In Progress |
| kimi11 | #2409 | — | pipeline | 采集管控[1/4] wdpp_pipeline_runs表 | In Progress |
| kimi16 | #1532 | — | backend | 矿场增强[7/23] 转化漏斗统计API | In Progress |
| kimi17 | #1630 | — | backend | 整改工单Phase27 API | In Progress |
| kimi19 | #2362 | — | frontend | 项目中心Phase9 详情全景页 | In Progress |
| kimi11 | #1994 | — | backend | 项目中心Phase15 风险事件API | In Progress |
