...
> 🔴 2026-04-09 整合：#2458/#2459 被批量 CLOSED (03:41/05:48)；#2509-#2519 合同管理增强7项(数据表/AI提取/自检/归档追踪/要点卡片/独立台账)全部 CLOSED 03:40
...
| ~~#2458~~ | ~~P1~~ | ~~backend~~ | ~~AI条款对比引擎(Python)~~ | ~~✅整合CLOSED 03:41~~ | — |
| ~~#2459~~ | ~~P1~~ | ~~backend~~ | ~~合同审批API(Python)~~ | ~~✅CLOSED 05:48~~ | — |
...
| ~~#1756~~ | ~~P1~~ | ~~frontend~~ | ~~前端看板+列表视图~~ | ~~✅整合CLOSED 03:41~~ | ~~等#2116~~ |
...
| ~~#1628~~ | ~~P1~~ | ~~backend~~ | ~~Phase29: AI视觉审查Service~~ | ~~✅整合CLOSED 03:41~~ | — |
| #1627 | P1 | backend | Phase30: 风险台账联动 | ✅ | #1628 CLOSED 解锁 |
| #2299 | P1 | frontend | 整改统计仪表盘 | ⏳ | 等#2303 |
| #2300 | P1 | frontend | AI审查结果展示 | ⏳ | #1628 CLOSED (无下游需求？) |
...
> **待手动 merge**（仍卡住）：PR#3524 (#2479 kimi16 idle 82min+) | PR#3491 (#2008 孤儿 UNSTABLE)
> **活跃中**：kimi3→#3458(PR#3487 进行中) | kimi16→#2479(等merge) | kimi1(RBAC空闲)
> **孤儿 DIRTY 待处理**：PR#3512(#1625)
> **分类提醒**：#3513(前端脚手架) / **#3514+#3515(纯SQL菜单重组)** / #3516(前端骨架) / #3517-#3522(重代码,每个5-8API+Widget页面) — 真正"菜单调整"只有#3514+#3515两个SQL Issue

> **整合摘要**（06:40发现）：03:28-29(44)历史Dev部署/E2E回归 | 03:39-40(30)合同管理系列+项目组织管理Phase1-15全关闭 | 03:41(7)CC跑中Issue(#1507/#1628/#1746/#1756/#1858/#1862/#2458) | 05:18-06:04(4)后续完成(#1744/#2459/#3452)

> **🔴 最高优先（流程验证）**：#3600 登录页底部版权替换 — 全流程 E2E 验证用
> **RBAC菜单整改10步串行链**：#3513→#3514→#3515[菜单重组]→#3516→#3517→#3518→#3519→#3520→#3521→#3522
> **次级待指派**：#2239[12/16政策Feed] | #1625[企微模板] | #1627[Phase30风险台账] | #2479[D3-AI] | #2094[验收] | #2028[项目变更]

| Issue | 优先 | 模块 | 内容 | 启动 |
|-------|------|------|------|------|
| ~~#3598~~ | ~~P0~~ | ~~frontend~~ | ~~替换登录页左上角名称~~ | ~~已完成(PR#3599 merged)~~ |
| **#3600** | **P0** | **frontend** | **替换登录页底部版权信息为 Copyright © 2026 Wande AI** | **🔴 Todo,立即指派 kimi1,effort=medium** |
| **#3513** | **P0** | **fullstack** | **[RBAC-1/10] 修复登录后Dashboard 404 + 品牌名替换为万德AI平台** | **🔴 Todo,立即指派,解锁菜单链** |
| **#3514** | **P0** | **backend** | **[RBAC-2/10] 创建4个业务角色(商务/支持/项目/综合) + RBAC菜单关联** | **⏳ 等#3513** |
| **#3515** | **P0** | **backend** | **[RBAC-3/10] 侧边栏菜单重组：拆散万德业务27项→4角色,清理空壳** | **⏳ 等#3514(菜单重组核心)** |
| **#3516** | **P0** | **fullstack** | **[RBAC-4/10] Dashboard路由分发+5角色Dashboard骨架+公告Widget** | **⏳ 等#3515** |
| **#3517** | **P0** | **fullstack** | **[RBAC-5/10] 商务主页Dashboard — 8个Widget(漏斗/回款/招投标)** | **⏳ 等#3516** |
| **#3518** | **P1** | **fullstack** | **[RBAC-6/10] 支持中心主页Dashboard — 6个Widget(设计/样品/安全/渲染)** | **⏳ 等#3516** |
| **#3519** | **P1** | **fullstack** | **[RBAC-7/10] 项目安装主页Dashboard — 7个Widget(项目/预算/风险/备件)** | **⏳ 等#3516** |
| **#3520** | **P1** | **fullstack** | **[RBAC-8/10] 综合管理主页Dashboard — 6个Widget(公告/权限/财务/政策)** | **⏳ 等#3516** |
| **#3521** | **P1** | **fullstack** | **[RBAC-9/10] Boss耀总Dashboard — 8大板块2x4入口导航页** | **⏳ 等#3516** |
| **#3522** | **P1** | **fullstack** | **[RBAC-10/10] Dashboard Widget配置表 + 动态渲染引擎** | **⏳ 等#3517-3521** |
...
| ~~#1506~~ | ~~P1~~ | ~~backend~~ | ~~[矿场-Phase2][13/16] 作战资料包聚合API~~ | ~~已指派kimi4(OPEN)~~ |
| ~~#1507~~ | ~~P1~~ | ~~backend~~ | ~~[矿场-Phase2][11/16] 政策信号关联推送~~ | ~~✅整合CLOSED 03:41~~ |
| #2239 | P1 | fullstack | [矿场-Phase2][12/16] 政策信号Feed页 — #1507解锁 | ✅ 依赖ready |
| #1627 | P1 | backend | [整改工单][Phase30] 风险台账联动 — 严重整改升级risk | ✅ #1628整合CLOSED解锁 |
| #1625 | P1 | backend | [企微] 整改通知消息模板 — 整改/超时/验收结果 | ✅ #1630完成解锁 |
| ~~#1746~~ | ~~P1~~ | ~~frontend~~ | ~~[质保售后] 售后工单管理主页面~~ | ~~✅整合CLOSED 03:41~~ |
| ~~#1742~~ | ~~P1~~ | ~~frontend~~ | ~~[质保] 质保台账管理页面~~ | ~~已指派kimi4~~ |
| ~~#1744~~ | ~~P1~~ | ~~frontend~~ | ~~[质保售后] 质保台账管理页面v2 — 台账+二维码~~ | ~~✅CLOSED 05:18~~ |
| ~~#2459~~ | ~~P1~~ | ~~backend~~ | ~~[合同管理] 合同审批流程API~~ | ~~✅CLOSED 05:48~~ |
| ~~#2458~~ | ~~P1~~ | ~~backend~~ | ~~[合同管理] AI条款对比引擎~~ | ~~✅整合CLOSED 03:41~~ |
...
> 更新：2026-04-09 07:45 UTC | 🔴 **排程经理越权指派**(用户直令)：kimi1 启动 RBAC菜单整改链路 #3513+#3514+#3515 (prompt模式,session=cc-wande-play-kimi1-c319ce23) | 研发经理忙其他任务
> **PLAN.md 当前运行表过时**：实际 lock 仅 kimi4/5/7/9/10/16/20(7个)有效,其他 kimi 目录已释放 | 当前运行 8/20 (kimi1新增+kimi4/5/7/9/10/16/20)
> **整合 CLOSED 历史**(06:40发现)：#1628(kimi1)/#1746(kimi2)/#2459(kimi3)/#3452(kimi6)/#2458(kimi11)/#1519(kimi12)/#1518(kimi13) — 实际 lock 均已释放

| 指派目录 | Issue | Tier | 模块 | 内容 | 进度 |
|------|-------|------|------|------|------|
| ~~**kimi1**~~ | ~~**#3513+#3514+#3515**~~ | ~~**P0**~~ | ~~**fullstack**~~ | ~~**🎉 RBAC菜单整改链路**~~ | ~~**✅ PR#3539 merged 08:05(全程~20min,排程经理越权指派)**~~ |
| ~~kimi1~~ | ~~#3598~~ | ~~P0~~ | ~~frontend~~ | ~~替换登录页左上角名称为 Wande AI Admin~~ | ~~✅ PR#3599 merged 2026-04-12 18:37~~ |
| kimi1 | #3600 | P0 | frontend | 替换登录页底部版权信息为 Copyright © 2026 Wande AI | 新启动(OPEN) |
| ~~kimi1-old~~ | ~~#1628~~ | ~~P1~~ | ~~backend~~ | ~~[整改工单] AI视觉审查Service~~ | ~~🔴 整合CLOSED 03:41,释放~~ |
| ~~kimi2~~ | ~~#1746~~ | ~~P1~~ | ~~frontend~~ | ~~[质保售后] 售后工单管理主页面~~ | ~~🔴 整合CLOSED 03:41,释放~~ |
| ~~kimi3~~ | ~~#2459~~ | ~~P1~~ | ~~backend~~ | ~~[合同管理] 合同审批API~~ | ~~🔴 CLOSED 05:48,释放~~ |
| kimi5 | #2008 | P0 | backend | [资金闭环][1/17] 报价成本模型API | PR#3491等CI |
| ~~kimi7~~ | ~~#2122~~ | ~~P0~~ | ~~backend~~ | ~~[执行管理] AI回款风险预警~~ | ~~✅ PR#3507 merged 07:31~~ |
| kimi9 | #1919 | P0 | frontend | [D3-Web] 电池包目录 | PR#3492等CI |
| ~~kimi11~~ | ~~#2458~~ | ~~P1~~ | ~~backend~~ | ~~[合同管理] AI条款对比引擎~~ | ~~🔴 整合CLOSED 03:41,释放~~ |
| ~~kimi12~~ | ~~#1519~~ | ~~P1~~ | ~~backend~~ | ~~[业务运营中心][5/8] 业务看板~~ | ~~🔴 整合CLOSED 03:40,释放~~ |
| kimi4 | #1506 | P1 | backend | [矿场-Phase2][13/16] 作战资料包聚合API | 新启动(OPEN) |
| ~~kimi13~~ | ~~#1518~~ | ~~P1~~ | ~~backend~~ | ~~[业务运营中心][7/8] 业务数据仪表盘~~ | ~~🔴 整合CLOSED 03:40,释放~~ |
| ~~kimi14~~ | ~~#1507~~ | ~~P1~~ | ~~backend~~ | ~~[矿场-Phase2][11/16] 政策信号关联推送~~ | ~~✅ PR#3508merged+03:41整合~~ |
| ~~kimi6~~ | ~~#3452~~ | ~~P0~~ | ~~fullstack~~ | ~~[项目挖掘改版][4/8] 项目分配功能~~ | ~~🔴 CLOSED 06:04,释放~~ |
| ~~kimi17~~ | ~~#2301~~ | ~~P0~~ | ~~frontend~~ | ~~[整改工单] 工人端H5拍照上传~~ | ~~✅ PR#3525 merged 06:38~~ |
| ~~kimi18~~ | ~~#2302~~ | ~~P0~~ | ~~frontend~~ | ~~[整改工单] 整改工单详情页~~ | ~~✅ PR#3502 merged 06:54~~ |
| ~~kimi19~~ | ~~#2303~~ | ~~P0~~ | ~~frontend~~ | ~~[整改工单] 整改工单列表+看板~~ | ~~✅ PR#3509 merged 07:05~~ |
...
| kimi1 | #3600 | P0 | frontend | 替换登录页底部版权信息为 Copyright © 2026 Wande AI | In Progress |
