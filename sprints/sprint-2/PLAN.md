...
|------|-------|------|--------|------|--------|
| ~~kimi1~~ | ~~#1496~~ | ~~backend~~ | ~~P2~~ | ~~NBO行动推荐生成 — Today's Top 3行动~~ | ~~✅ PR#4431 MERGED~~ |
| kimi2 | #1497 | backend | P2 | NBO评分引擎 — 项目适配度×意图×赢率综合评分 | 48% 🔥 |
| kimi3 | #1538 | budget | P2 | D3造价回填接口 — D3设计完成后自动写入设备科目预算 | 66% 🔥 |
| kimi4 | #1539 | budget | P2 | 历史基准自动积累 — 项目关闭时自动更新成本基准库 | 47% ⚠️⚠️⚠️（56%→47%，连续3轮回退累计-26%） |
| kimi5 | #1590 | budget | P2 | 项目成本复盘报告自动生成 | 49% 🔥 |

> **4 CC活跃**；kimi4连续3轮回退73%→66%→56%→47%，累计降26个百分点，情况恶化需紧急干预；其他3 CC持平（kimi2 48%/kimi3 66%/kimi5 49%）；kimi1 CC持平52%；PR#4415/4421/4422/4423/4424已merged；PR#4431/4427/4425/4426 REVIEW_REQUIRED
