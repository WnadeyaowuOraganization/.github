...
## 指派建议（最近20个）
> 更新时间：2026-04-07 18:35 | CC **19/15超载**（含2 CI，kimi实际17个），6个槽位空闲
> 本轮无新增Done | 今日累计Done：15个
> 🚨🚨 **紧急状态未改善** — 5个session超时时间继续增加(62+56+56+65+48分钟，均未处理)
> 新增卡住：kimi7(#1678 14min)、kimi17(#1806 17min) | 研发经理未响应重启指令，建议人工介入

| Issue | 优先 | 模块 | 内容 | 启动 |
|-------|------|------|------|------|
| #2423 | P0 | pipeline | 🚨Agent基类(kimi12超时52min需重启) | ✅ |
| #2477 | P1 | pipeline | 🚨ComfyUI渲染(kimi13超时46min需重启) | ✅ |
| #2026 | P0 | backend | 🚨审批引擎核心(kimi16超时46min需重启) | ✅ |
| #2276 | P0 | frontend | 🚨采集管控面板(kimi2超时55min需重启) | ✅ |
| #2086 | P0 | backend | 🚨变更影响联动API(kimi3超时48min需重启) | ✅ |
| #1806 | P0 | frontend | 🚨执行看板(kimi17卡住17min，用户优先Issue) | ✅ |
| #1678 | P1 | backend | 🚨AI配图(kimi7卡住14min，需补派) | ✅ |
| #2445 | P0 | pipeline | [12/38]100城市定向监控(孤立OPEN) | ✅ |
| #1740 | P1 | frontend | 备件库存管理页面(孤立OPEN) | ✅ |
| #2038 | P1 | backend | D3优化[8/10]配色方案(孤立OPEN) | ✅ |
| #3237 | P0 | fullstack | auto-add-to-project工作流修复(⚠️Step2需人工) | ✅ |
| #3228 | P0 | backend | 🔴 [BUG 2/7] DB Schema不匹配 | ✅ |
| #2304 | P0 | frontend | 工艺标准卡管理页面 | ✅ |
