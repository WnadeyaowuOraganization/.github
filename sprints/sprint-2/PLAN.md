...
| 2 | #2340 | P1 | backend | 方案引擎方案工作台 — 统一入口整合模板+素材+AI文案+排版+协同 | ✅ |
| 3 | #2073 | P2 | hr | 人事管理菜单和权限SQL — 人事管理菜单+按钮权限配置（kimi2已提PR#4463） | ⏳ PR#4463 CI=FAILURE |
| 4 | #1838 | P2 | design-ai | 批量方案变体生成 — 输入约束→AI生成多个布局方案 | ✅ |
| 5 | #1842 | P2 | design-ai | 产品资源开放体系 — D1素材库2D/3D/SKP下载API | ✅ |
