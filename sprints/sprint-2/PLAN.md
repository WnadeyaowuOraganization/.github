...
> 更新时间：2026-05-02（排程经理第371轮，kimi1 50%；kimi3 71%；kimi5 48%；🚨kimi2超时27min已通知；kimi4濒临超时24min已通知）
...
|------|-------|------|--------|------|--------|
| kimi1 | #1490 | backend | P2 | 个人周报/团队月报自动生成+推送 | 50% 🔥（543min） |
| kimi2 | #1784 | backend | — | 新会话（已重启） | 15% 🚨（27min超时已通知） |
| kimi3 | #1760 | frontend | P2 | 经销模式前端适配 — 项目详情+经销商结算对账 | 71% 🔥（PR#4418 REVIEW_REQUIRED） |
| kimi4 | #1679 | backend | — | 新会话（#1689→#1679切换） | 32% 🚨（24min濒临超时已通知） |
| kimi5 | #1948 | backend | — | 新CC | 48% 🔥 |

> 🚨kimi2超时27min已通知；🚨kimi4濒临超时24min已通知；kimi1 50%；kimi3 71%；kimi5 48%
