...
> ⏰ 最后更新：2026-04-07 16:11 by Perplexity
...
| Sprint-2 | ⏳ 待启动 | 2026-04-12 | — | 153 | 执行管理、CRM、审批引擎P0、方案引擎P0、H5基座、**企微审批贯通**、**流程补齐·通用表单** | 签约后能建项目→图纸/BOM管理→回款跟踪；合同/报价能走审批；商务能用PPT插件做方案；**企微内可发起/审批；47个OA遗留流程全覆盖** |
