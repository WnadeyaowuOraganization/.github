...
| kimi5 | #3714 | P0 | backend | 执行管理v2.0 [9/22] 交付节点API（里程碑+发货批次），配对#3717前端 PR#3751⏳ | 02:50 启动 |
...
| kimi1 | #3724 | P1 | frontend | 执行管理v2.0 [19/22] Tab5变更管理（KPI+列表+详情），mock配对#3722 PR#3752⏳ | 04:02 启动 |
| ~~kimi2~~ | ~~#3717~~ | ~~P0~~ | ~~frontend~~ | ~~执行管理v2.0 [12/22] Tab3合同与交付（合同状态+交付节点+发货跟踪）~~ PR#3747✅merged 2026-04-16 03:18 | ~~Done~~ |
| kimi2 | #3721 | P0 | backend | 执行管理v2.0 [16/22] 工艺路线+设备进度矩阵API | 03:26 启动 |
...
| kimi3 | #3722 | P1 | backend | 执行管理v2.0 [17/22] 变更管理API（记录+影响分析+审批） | 04:09 启动 |
...
| kimi4 | #3725 | P0 | backend | 执行管理v2.0 [20/22] 验收管理API（5级验收+检查项） | 04:17 启动 |
