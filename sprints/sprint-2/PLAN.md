...
| # | Issue | 优先级 | 模块 | 说明 | 启动 |
|---|-------|--------|------|------|------|
| 1 | ~~#3203~~ | P1 | backend | BOM变更→计划联动引擎 — 变更事件驱动计划自动调整 [11/11] | ✅ 已提 PR #4592 |
| 2 | ~~#3202~~ | P1 | fullstack | 管理层计划仪表盘 — 多项目汇总+健康度评分 [10/10] | ✅ 已指派 kimi2 |
| 3 | ~~#3201~~ | P1 | frontend | 供应商排程管理页面 — 三段式+日历排程 [9/10] | ✅ 已指派 kimi3 |
| 4 | ~~#2657~~ | P1 | fullstack | 品牌中心·内容自动化 — 内容日历+海报/文章审批工作台+发布管理 [5/5] | ✅ 已指派 kimi4 |
| 5 | ~~#2644~~ | P1 | fullstack | 品牌中心·员工代言 — 内容池管理+员工分享看板+H5分享页 [2/2] | ✅ 已指派 kimi5 |
| 6 | ~~#2637~~ | P1 | frontend | 品牌中心·数字人 — AI视频生成工作台+审批队列 [5/7] | ✅ 已提 PR #4594 MERGED |
| 7 | ~~#2660~~ | P1 | frontend | 色卡配色器 — 交互式配色面板+实时预览 [2/4] | ✅ 已提 PR #4595 MERGED |
| 8 | ~~#2740~~ | P1 | frontend | 商战情报中台·分发 — 移动端情报快览小程序 [5/8] | ✅ 已指派 kimi1 |
| 9 | ~~#3116~~ | P1 | pipeline | 经销商发现 — 评分模型增加「专注度检验」维度 | ✅ 已提 PR #4596 |
| 10 | ~~#2495~~ | P1 | pipeline | 竞品情报Phase4 — T2级14家扩展采集 | ✅ 已指派 kimi3 |
| 11 | ~~#2413~~ | P2 | pipeline | 竞品出口客户反向采集 — 凯奇/奇特乐/永浪海外买家（海外客户发现 [2/3]） | ✅ 已指派 kimi4 |
...
| 14 | ~~#2664~~ | P2 | backend | 库存联通 — 多仓库库存查询+智能调拨单API [2/3] | ✅ 已提 PR #4604 |
...
| 05-11 | kimi4 | #2657 | fullstack | P1 | In Progress | 品牌中心·内容自动化 — 内容日历+海报/文章审批工作台+发布管理 [5/5] |
| 05-11 | kimi5 | #2644 | fullstack | P1 | In Progress | 品牌中心·员工代言 — 内容池管理+员工分享看板+H5分享页 [2/2] |
| 05-11 | kimi1 | #2740 | frontend | P1 | In Progress | 商战情报中台·分发 — 移动端情报快览小程序 [5/8] |
