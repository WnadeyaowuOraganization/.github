...
| Issue | 优先 | 模块 | 内容 | 启动 |
|-------|------|------|------|------|
| #3631 | P1 | bidding | pipeline↔后端表对齐全景规划 | ✅ |
| #2028 | P1 | backend | 矿场项目信息增量同步推送 | ✅ |
| #2243 | P1 | backend | 简报偏好设置页 | ✅ |
| #2238 | P1 | frontend | 作战资料包一页纸展示 | ✅ |
| #3193 | P1 | backend | 项目主计划数据模型 | ✅ |
| #1692 | P1 | backend | 项目成本跟踪 API | ✅ |
| #2097 | P1 | backend | 验收检查项模板管理 | ✅ |
| #3108 | P2 | backend | 合同数据表扩展 | ✅ |
| #2113 | P1 | backend | 合同审批流程 | ✅ |
| #1750 | P1 | frontend | AI条款对比前端 | ✅ |
| #1999 | P2 | finance | 阶段凭证数据库 | ✅ |
| #1997 | P2 | finance | 回款周报数据库+引擎 | ✅ |
| #1874 | P1 | backend | 前期项目跟进提醒 | ✅ |
| #1790 | P1 | frontend | 变更影响分析面板 | ✅ |
| #1808 | P1 | frontend | 采购/生产/安装 Tab | ✅ |
| #1728 | P1 | execution | 施工安全管理页面 | ✅ |
| #2351 | P1 | project | 项目列表健康度灯 | ✅ |
| #2352 | P2 | project | 风险台账 Tab | ✅ |
| #1896 | P1 | crm | 客户情报增强 | ✅ |
| #2258 | P1 | crm | 商机下设计单前端 | ✅ |

## 当前运行

| 指派目录 | Issue | Tier | 模块 | 内容 |
|---------|-------|------|------|------|
| kimi1 | #3631 | Tier-A | bidding | pipeline↔后端表对齐全景规划 |
...
|---------|-------|------|------|------|---------|
| kimi1 | #3631 | Tier-A | bidding | pipeline↔后端表对齐全景规划 | In Progress |
