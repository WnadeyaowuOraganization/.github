...
> 更新时间：2026-05-12（排程经理第1143轮；Todo紧急补充3个P3 Issue；共12个Todo可指派）
...
| 6 | #2476 | P1 | backend | D3-AI·AI建模助手试点验证 — 1套产品端到端流程 [3/3] | ✅ |
| 7 | #2017 | P1 | backend | 数据迁移·明道云权限模式提取 — 从53645条权限记录生成权限模板 [18/22] | ✅ |
| 8 | #1766 | P1 | frontend | 代理商工作台·前端管理页面 — 五阶段管线+看板+列表 | ✅ |
| 9 | #1754 | P2 | frontend | 代理商工作台·模块数据打通前端 — 关联项目+中标方标签 | ✅ |
| 10 | #2496 | P2 | pipeline | 竞品情报·T3级30家补充采集 — 全球游乐设施行业全覆盖（T2已完成） | ✅ |
| 11 | #2396 | P3 | pipeline | 矿场·国际信息源适配器-北美 — SAM.gov+ConstructConnect采集 [1/10] | ✅ |
| 11 | #2395 | P3 | backend | 矿场·国际信息源适配器-欧洲/中东/东南亚 — TED/GlobalTenders/GeBIZ [2/10] | ✅ |
| 12 | #2394 | P3 | backend | 矿场·国际公告多语言翻译 — LLM自动翻译标题和摘要 [4/10] | ✅ |
...
| #2496 | ~~❌ 依赖缺失~~ → T2已完成（#2493/#2494/#2495 CLOSED），已解除阻塞，转入主表 | Todo ✅ |
