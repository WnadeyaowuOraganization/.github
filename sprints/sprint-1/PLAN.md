...
## 指派建议（最近20个）
> 🔄 **更新** 2026-04-08 09:30 UTC | #1726/#2399 Done；#2183 已IP移除；#2237 新解锁Todo(#2399→赢率模型)

| Issue | 优先 | 模块 | 内容 | 启动 |
|-------|------|------|------|------|
| #2237 | P1 | backend | [矿场-Phase3][4/12] 项目列表赢率列与排序（#2399 Done解锁） | ✅ |
...
> 更新：2026-04-08 09:23 UTC | 满槽15/15 | kimi15(#1726✅PR#3420)→Done→#2183；kimi1/kimi9注入PR创建；kimi13提交中

| 指派目录 | Issue | Tier | 模块 | 内容 | 进度 |
|------|-------|------|------|------|------|
| kimi1 | #2399 | T1 | pipeline | [矿场-Phase3][2/12] 赢率预测模型训练Pipeline | 注入PR创建 |
| kimi2 | #1863 | P0 | frontend | [产品平台][P0] D3 Web产品目录浏览器 | 15% |
...
| kimi6 | #1867 | P0 | pipeline | [D3-v2.0][P0] D3 AI知识体系构建 | 20% |
| kimi7 | #2465 | T1 | backend | [执行管理] 生产进度/质检/发货/安装API | 38% |
| kimi8 | #1508 | T1 | backend | [矿场-Phase2][8/16] 决策链联系人角色标签 | 38% |
| kimi9 | #2403 | T1 | pipeline | [矿场-Phase2][2/16] 企业工商数据采集 | 注入PR创建 |
| kimi10 | #2228 | T1 | frontend | [矿场-Phase4][13/17] 管理看板-团队活动量 | 36% |
| kimi11 | #2009 | T1 | backend | [项目中心Phase7] 项目全景API | 47% |
| kimi12 | #1756 | T1 | frontend | [代理商工作台] 前端看板+列表视图 | 42% |
| kimi13 | #1766 | T1 | frontend | [代理商工作台] 前端管线+五阶段看板 | 55% 提交中 |
| kimi14 | #2012 | T1 | backend | [项目中心Phase4] 跨部门任务Service | 38% |
| kimi15 | #2183 | T1 | backend | [执行管理] 扩展角色权限 | 启动中 |
