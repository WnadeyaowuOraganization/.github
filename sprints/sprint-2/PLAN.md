...
| # | Issue | 优先级 | 模块 | 说明 | 启动 |
|---|-------|--------|------|------|------|
| 1 | #2747 | P1 | backend | 客户生命周期[4/12] 客户满意度回访提醒 — 验收后自动创建回访任务（kimi1已接） | 🔥 |
...
|------|-------|------|--------|------|--------|
| kimi1 | #2747 | backend | P1 | 客户生命周期[4/12] 客户满意度回访提醒 | 编码中 |
| kimi2 | #3208 | backend | P1 | 总控预算增强[1/10] — budget_zone表+BudgetItem增加zone_id | 编码中 |
| kimi3 | #2738 | backend | P1 | 商战情报中台·分发[3/8] 邮件订阅与定时报告 | 编码中 |
