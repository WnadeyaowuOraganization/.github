...
| kimi1 | #3726 | P2 | backend | 执行管理v2.0 [21/22] 质保+售后工单+设备档案API | 07:18 M2 jar修复中（第4次止血）|
...
| kimi4 | #1531 | P1 | backend | [矿场增强] 可赢性评分模型(Win Probability) — 4维度综合赢率计算 | PR#3767⏳ 等待CI merge |
