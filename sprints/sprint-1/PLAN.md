...
| kimi2 | #3133 | P0 | backend | [审批引擎] 审批节点回退增强（回退到指定节点+直达模式） PR#3756⏳ CI质量预检修复中 | 06:08 PR创建 |
...
| kimi4 | #3725 | P0 | backend | 执行管理v2.0 [20/22] 验收管理API（5级验收+检查项） | 06:08 重建中（工作区清理，已注入设计context快速重建） |
