...
## 指派建议（最近20个）
> 更新时间：2026-04-07 18:05 | CC **19/15超载**（含2 CI，kimi实际17个），6个槽位空闲
> 本轮无新增Done | 今日累计Done：15个 | **系统部分恢复**：6个kimi已恢复，3个仍卡住
> 仍卡住(26+26+18min)：#2477(kimi13)/#2026(kimi16)/#2086(kimi3) | 5个Issue待补派：#2423/#1806/#2276(新退出) + #2445/#1740/#2038

| Issue | 优先 | 模块 | 内容 | 启动 |
|-------|------|------|------|------|
| #2423 | P0 | pipeline | Agent基类(kimi12退出OPEN,卡住22min) | ✅ |
| #1806 | P0 | frontend | 执行项目总看板(kimi17退出OPEN,卡住22min) | ✅ |
| #2276 | P0 | frontend | 采集管控面板(kimi2退出OPEN,卡住25min) | ✅ |
