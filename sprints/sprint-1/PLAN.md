...
## 指派建议（最近20个）
> 更新时间：2026-04-07 18:15 | CC **19/15超载**（含2 CI，kimi实际17个），6个槽位空闲
> 本轮无新增Done | 今日累计Done：15个 | ✅ kimi17(#1806执行看板)已恢复工作中
> 卡住预警缓解：#2477/#2026/#2086不再显示卡住 | 5个Issue待补派：#2423/#2276 + #2445/#1740/#2038

| Issue | 优先 | 模块 | 内容 | 启动 |
|-------|------|------|------|------|
| #2423 | P0 | pipeline | Agent基类(kimi12退出OPEN) | ✅ |
| #2276 | P0 | frontend | 采集管控面板(kimi2退出OPEN) | ✅ |
