...
| Issue | 优先 | 模块 | 内容 | 启动 | 前置 |
|-------|------|------|------|------|------|
| #3468 | P1 | fullstack | 全球项目矿场v3.0 — 挖掘/我的项目/国际矿场 | **立即** | #3597(菜单基线) |
...
| Issue | 优先 | 模块 | 内容 | 启动 | 前置 |
|-------|------|------|------|------|------|
| #3475 | P0 | fullstack | CRM商务中心Master — DB Schema + 路由框架 | ✅ | #3597 |
| #3528 | P1 | fullstack | CRM-01 商务工作台 — KPI+收件箱+业绩面板 | ⏳ | #3475 |
...
| #3548 | P1 | fullstack | CRM-13 公司通讯录 — 全员联系人+部门树 | ⏳ | #3475 |
...
Week 1 (4/12-4/18):
  ...
  Tier-2: #3468 全球项目矿场Master (快速路线，1CC)
  Tier-3: #3466 超管驾驶舱验证
...
Week 2 (4/19-4/25):
  ...
  Tier-4: #3475 CRM Master + #3528 CRM-01
