...
| 指派目录 | Issue | 模块 | 内容 | 状态 |
|---------|-------|------|------|------|
| kimi1  | #3162 | wecom | 企微审批贯通2/6 — 审批流程引擎回调处理+状态变更同步 | 已派 |
| kimi3  | #2365 | approval | SLA规则配置页+审批统计看板（Phase9/10） | 已派 |
| kimi4  | #3132 | approval | 审批抄送功能 — 节点级/完成级抄送+规则配置+企微通知 | 已派 |
| kimi6  | #3164 | wecom | 企微审批贯通4/6 — 审批消息卡片增强（企微内一键审批+富文本摘要） | 已派 |
| kimi19 | #3163 | wecom | 企微审批贯通3/6 — H5审批发起页适配（企微内嵌H5+OAuth免登+移动端） | 已派 |
...
| kimi1  | #3162 | wecom | 企微审批贯通2/6 — 审批流程引擎回调处理+状态变更同步 | 已派 |
| kimi4  | #3132 | approval | 审批抄送功能 — 节点级/完成级抄送+规则配置+企微通知 | 已派 |
| kimi6  | #2364 | approval | 审批中心菜单权限注册 — 综合管理中心+公共板块+权限配置 | 已派 |
| kimi19 | #2270 | wecom | ~~H5工作台入口页(企微内嵌H5+JS-SDK初始化)~~ | ~~Done(PR#3914 admin-merged)~~ |
| kimi19 | #3163 | wecom | 企微审批贯通3/6 — H5审批发起页适配（企微内嵌H5+OAuth免登+移动端） | 已派 |
| kimi3  | #2366 | approval | ~~审批中心前端(待办/已办/发起/抄送+全栈约30文件2500行)~~ | ~~Done(PR#3915 admin-merged)~~ |
| kimi6  | #2364 | approval | ~~审批中心菜单权限注册(菜单ID#19009-19034+角色权限绑定)~~ | ~~Done(PR#3916 admin-merged)~~ |
| kimi3  | #2365 | approval | SLA规则配置页+审批统计看板（Phase9/10） | 已派 |
| kimi6  | #3164 | wecom | 企微审批贯通4/6 — 审批消息卡片增强（企微内一键审批+富文本摘要） | 已派 |
