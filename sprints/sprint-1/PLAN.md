...
> **🔴 最高优先（流程验证）**：#3598 登录页品牌名替换 — 全流程 E2E 验证用
...
| Issue | 优先 | 模块 | 内容 | 启动 |
|-------|------|------|------|------|
| **#3598** | **P0** | **frontend** | **替换登录页左上角名称为 Wande AI Admin** | **🔴 Todo,立即指派 kimi1,effort=medium** |
...
| kimi1 | #3598 | P0 | frontend | 替换登录页左上角名称为 Wande AI Admin | 新启动(OPEN) |
...
| kimi1 | #3598 | P0 | frontend | 替换登录页左上角名称为 Wande AI Admin | In Progress |
