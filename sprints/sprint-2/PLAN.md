...
| 3 | ~~#2647~~ | P2 | pipeline | 品牌中心·SEO — SEO内容自动生成管线（关键词→文章→发布）[1/2] | ~~✅ 重新指派 kimi1~~ |
| 4 | ~~#2638~~ | P2 | pipeline | 品牌中心·数字人 — AI自动脚本生成+定时视频生产管线 [6/7] | ~~✅ 已指派 kimi8~~ |
| 5 | ~~#2642~~ | P2 | pipeline | 品牌中心·视频裂变 — 自动视频裂变处理管线（ffmpeg+AI文案）[3/3] | ~~✅ 已指派 kimi1 PR #4621 OPEN~~ |
...
| 8 | ~~#2676~~ | P2 | fullstack | 商战情报中台·基础设施 — 实体知识图谱（关系抽取+图存储）[3/12] | ~~✅ MERGED PR #4624~~ |
| 9 | ~~#2677~~ | P2 | pipeline | 商战情报中台·基础设施 — 共享采集引擎（统一采集入口）[4/12] | ~~✅ 已指派 kimi5 PR #4622 OPEN~~ |
| 10 | ~~#2679~~ | P2 | fullstack | 商战情报中台·基础设施 — 情报去重与合并（实体消歧）[6/12] | ~~✅ MERGED PR #4625~~ |
| 11 | ~~#2685~~ | P2 | fullstack | 商战情报中台·基础设施 — 全文检索与语义搜索（ES+向量）[12/12] | ~~✅ 已指派 kimi7 PR #4626 OPEN~~ |
| 12 | ~~#2686~~ | P2 | fullstack | 商战情报中台·行业信息 — 行业档案7章节结构化（游乐设备行业）[1/10] | ~~✅ 已指派 kimi8~~ |
| 13 | ~~#2687~~ | P2 | pipeline | 商战情报中台·行业信息 — 政策法规自动采集+归档 [2/10] | ~~✅ 已指派 kimi2~~ |
| 14 | ~~#2689~~ | P2 | fullstack | 商战情报中台·行业信息 — 市场趋势仪表盘（行业规模/增速/格局）[4/10] | ~~✅ 已指派 kimi3~~ |
| 15 | ~~#2694~~ | P2 | fullstack | 商战情报中台·行业信息 — 行业展会与会议信息采集 [9/10] | ~~✅ 已指派 kimi4~~ |
| 16 | ~~#2695~~ | P2 | fullstack | 商战情报中台·行业信息 — 行业信息中心 Hub [10/10] | ~~✅ 已指派 kimi5~~ |
