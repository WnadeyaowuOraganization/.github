...
|------|-------|------|--------|------|--------|
| kimi3 | #1613 | wechat | P1 | 数据安全分级与访问控制 | PR #4182 CI初始化 |
| kimi4 | #1614 | wechat | P1 | PII自动脱敏服务 | PR #4181 质量预检运行 |
| kimi5 | #1873 | bidding | P1 | 分级超时升级机制 | 60%，沉默22分 |
...
| kimi | Issue | PR | 状态 |
|------|-------|----|----|
| kimi1 | ~~#1594~~ | #4179 | merged |
| kimi2 | ~~#1599~~ | #4180 | merged |
| kimi3 | #1613 | #4182 | ⏳ CI运行中 |
| kimi4 | #1614 | #4181 | ⏳ CI运行中 |
