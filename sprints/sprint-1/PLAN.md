...
| #2252 | P1 | frontend | [20/23] 来源ROI看板 | ✅ | #1528 CLOSED→Todo |
...
| #1507 | P1 | backend | [11/16] 政策信号关联推送 | ✅ | #2401 Done→Todo |
...
## 指派建议（最近20个）
> 🔄 **更新：2026-04-08 18:20 UTC | 容量 16/15 → 5个CC占CLOSED Issue将释放 | D3-v2.0 P0多个待启动 | 资金闭环#2008待启动**

| Issue | 优先 | 模块 | 内容 | 启动 |
|-------|------|------|------|------|
| #1921 | P0 | design-ai | [D3-v2.0][紧急] D3Plugin.gha SDK版本降级 — 兼容Rhino 8.0+所有版本 | ✅ 独立bugfix |
| #2008 | P0 | backend | [资金闭环][1/17] 报价成本模型API — BOM+运费+安装+管理费→建议售价 | ✅ 独立 |
| #1938 | P0 | design-ai | [D3-v2.0][Phase1-1/4] 电池包制造级管件精度升级 — 11种标准管建模 | ✅ Phase1串行1st |
| #1947 | P0 | design-ai | [D3最小单元] 邵鹏电池包连接公式提取 — 9个Cluster拆解为组合规则 | ✅ 独立 |
| #1946 | P0 | design-ai | [D3最小单元] 合并功能件参数化名单 — 邵鹏7件+#1196规划9件统一16件 | ✅ 独立 |
| #1919 | P0 | frontend | [D3-Web] 电池包目录 — 分类浏览+参数说明+缩略图+3D预览 | ✅ 独立 |
| #1918 | P0 | frontend | [D3-Web] 参数配置器 — 表单输入+实时计算+推送到GH | ✅ 独立 |
| #1917 | P0 | frontend | [D3-Web] 设计师自助上传 — .gh文件上传+参数自动识别+发布审核 | ✅ 独立 |
| #1933 | P0 | design-ai | [D3-v2.0][Phase2-2/6] 螺旋滑梯电池包 — 邵鹏参数+塑料滑桶 | ⏳ 等Phase1完成 |
| #1932 | P0 | design-ai | [D3-v2.0][Phase2-3/6] 秋千/吊环电池包 — 独立件+A型架 | ⏳ 等Phase1完成 |
| #2459 | P1 | backend | [合同管理] 合同审批API — AI辅助快速审批流程 | ✅ 独立 |
| #2458 | P1 | backend | [合同管理] AI条款对比引擎 — 我方标准vs甲方版本逐条Diff | ✅ 独立 |
| #2479 | P1 | backend | [D3-AI][3/3] 账号池AI渲染集成 — 多平台API封装+统一调度 | ✅ #2477 CLOSED解锁 |
| #1856 | P1 | backend | [产品平台] 非标件成本系数库 — 开模费/工时费率/设计费率 | ✅ 独立 |
| #2028 | P1 | backend | [项目矿场] 项目信息变更增量同步推送 — 持续更新业务员信息 | ✅ 独立 |
| #1928 | P1 | pipeline | [D3-v2.0][Phase3-1/3] v2.0电池包→图纸输出桥接 — 制造级数据驱动 | ✅ 独立 |
| #2037 | P1 | backend | [D3-优化][10/10] 改造/翻新模式 — 已有结构约束下的设计 | ✅ 独立 |
| #2126 | P1 | backend | [经销商发现] 修正版种子数据+方法论后端 | ✅ 独立 |
| #2119 | P2 | backend | [执行管理] 经销模式支持 — 阶段配置+经销商结算+门户API | ✅ 独立 |
| #2093 | P3 | backend | [执行管理] AI增强验收 — 智能检查清单+报告+智能派单 | ✅ 独立 |

---

# 以下内容由研发经理每次指派前维护

## 当前运行（3 常规 + 9 P0冲突修复 + 1新指派 + 1挖掘 = 15/15满载）

> 更新：2026-04-08 18:19 UTC | kimi3#2851 PR#3459已创建→Done；kimi8#1564 PR#3465已创建→Done；kimi13#3450新指派
...
| kimi12 | #1858 | P1 | backend | [产品平台][P1] 方案版本对比 | CI运行中 |
| kimi13 | #3450 | P0 | fullstack | [项目挖掘改版][2/8] 配合单位联系方式显示 | 0%（18:19新指派） |
| kimi14 | #2589 | P0 | backend | [**冲突修复**] execution执行管理 PR#3317 rebase | 运行中 |
| kimi15 | #1862 | P1 | backend | [产品平台][P1] 标准品报价引擎 | 运行中 |
