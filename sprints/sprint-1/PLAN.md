...
## 指派建议（最近20个）
> 🔄 **更新** 2026-04-08 12:00 UTC | #2228/#2012/#2009/#2253/#2183/#1867 Done；#2361/#1993 新Todo(#2012+#2471+#2009解锁)；#1920/#2240/#2255/#1463 已IP移除；kimi3空闲1槽
...
| #2260 | P1 | budget | [预算模板11/12] 项目预算编制增强 — 多维度子项管控 | ⏳ 等#2261 |
| #2119 | P2 | backend | [执行管理] 经销模式支持 — 独立 | ✅ |
| #2093 | P3 | backend | [执行管理] AI增强验收 — 独立 | ✅ |
| #2253 | P1 | frontend | [矿场增强][18/23] 企微H5矿场页面 — 已Done | — |
| #1463 | P1 | backend | [销售记录体系][3/9] 智能提醒频率引擎 — kimi10已接 | — |
