...
| 9 | #1686 | P2 | backend | 报销费控 — 项目费用关联+财务报表导出+供应商联动 | ✅ |
| 10 | #1698 | P2 | backend | 提成绩效 — 提成计算引擎API(阶梯计算+绩效系数+批量) | ✅ |
| 11 | #1597 | P2 | budget | 员工借款额度校验Service | ✅ |
| 12 | #1601 | P2 | budget | 报销申请接入预算关卡 | ✅ |
| 13 | #1551 | P2 | wecom | 企微待办API对接 — 审批待办+任务待办推送 | ✅ |
| 14 | #1818 | P2 | brand | 平台定制发布 — 多平台标题/标签/封面微调 | ✅ |
| 15 | #1824 | P2 | brand | 内容创作/编辑页面 — 富文本+多媒体上传+双语编辑 | ✅ |
