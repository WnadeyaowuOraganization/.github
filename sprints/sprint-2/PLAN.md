...
> 更新时间：2026-05-02（排程经理第372轮，🚨kimi2超时20min(16%)已通知；🚨kimi4超时20min(17%)已通知；kimi1 46%；kimi3 59%；kimi5 48%；基础设施修复已完成）
...
|------|-------|------|--------|------|--------|
| kimi1 | #1490 | backend | P2 | 个人周报/团队月报自动生成+推送 | 46% 🔥（573min） |
| kimi2 | #1784 | backend | — | 新会话（已重启） | 16% 🚨（20min超时已通知） |
| kimi3 | #1760 | frontend | P2 | 经销模式前端适配 — 项目详情+经销商结算对账 | 59% 🔥（PR#4418 REVIEW_REQUIRED） |
| kimi4 | #1679 | backend | — | 新会话（#1689→#1679切换） | 17% 🚨（20min超时已通知） |
| kimi5 | #1948 | backend | — | 新CC | 48% 🔥 |

> 🚨kimi2超时20min(16%)已通知；🚨kimi4超时20min(17%)已通知；基础设施修复已完成；kimi1 46%；kimi3 59%；kimi5 48%
