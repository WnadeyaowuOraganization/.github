...
|---------|-------|------|------|------|------|
| kimi1  | #3377 | P0 | plm/backend | PLM子系统数据库初始化 — 7张核心表建表+索引 | 无依赖，PLM系列入口，GitHub OPEN确认 |
| kimi3  | #3653 | P2 | bidding/fullstack | 招投标-E 报价决策与保证金台账 | 前置#3648✅Done（#44不存在视为满足），有原型 |
