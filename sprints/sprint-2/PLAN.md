...
> 更新时间：2026-05-05（排程经理第816轮；kimi1空闲/kimi2 PR#4457 OPEN/kimi3 PR#4454，Todo 22项）
...
> 更新时间：2026-05-05（排程经理第816轮；kimi1空闲/kimi2 PR#4457 OPEN等待合并/kimi3 PR#4454单测FAIL）
...
| 2 | ~~#1611~~ | P2 | chat | ~~消息线程化与兴趣匹配~~ → **PR#4455 MERGED** | ✅ CLOSED |
| 3 | ~~#1882~~ | P2 | frontend | ~~素材库-列表查询+多维度筛选+权限过滤~~ → **PR#4450 MERGED** | ✅ CLOSED |
| 4 | ~~#1612~~ | P2 | chat | ~~业务场景自动分类引擎~~ → **PR#4457 OPEN** | ⏳ In Progress |
| 5 | ~~#1843~~ | P2 | design-ai | ~~招标规范文本自动生成~~ → **PR#4456 MERGED** | ✅ CLOSED |
...
| 9 | #2069 | P2 | auth | 企微OAuth扫码登录后端API | ✅ |
| 10 | #1666 | P2 | biz-enablement | AI参数问答助手API — 结构化数据精准回答+投标辅助填表 | ✅ |
| 11 | #2132 | P2 | backend | RBAC功能权限管控 — 10个新模块+功能发布开关+权限校验 | ✅ |
| 12 | #2070 | P1 | hr | 培训管理菜单权限SQL — 培训管理5个二级菜单+按钮权限 | ✅ |
| 13 | #2071 | P1 | hr | 培训管理后端Controller API — 培训计划/课程/记录/证书/评估接口 | ✅ |
| 14 | #2072 | P1 | hr | 培训管理Entity+Mapper+Service — 培训计划/课程/记录/证书/评估 | ✅ |
