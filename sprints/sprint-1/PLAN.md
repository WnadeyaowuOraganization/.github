...
## 指派建议（最近20个）
> 更新时间：2026-04-07 11:38 | CC状态：15/15满载，等槽位释放后按序指派

| Issue | 优先 | 模块 | 内容 | 启动 |
|-------|------|------|------|------|
| #2256 | P0 | frontend | 矿场增强[6/23] 列表状态筛选+流转 | ✅ |
| #2159 | P0 | backend | 质保售后 创建12张表+Alembic迁移 | ✅ |
| #2107 | P0 | backend | 质保售后 备件管理API | ✅ |
| #2108 | P0 | backend | 质保售后 外包维修商管理API | ✅ |
| #2109 | P0 | backend | 质保售后 售后工单API | ✅ |
| #2110 | P0 | backend | 质保售后 质保台账API | ✅ |
| #2106 | P0 | backend | 质保售后 备件消耗关联工单 | ✅ |
| #1700 | P0 | backend | 提成绩效 创建5张表 | ✅ |
| #2471 | P0 | backend | 项目中心Phase13 project_risk_events等6张表 | ✅ |
| #2047 | P0 | backend | AI投标Phase1 ComfyUI基础设施 | ✅ |
| #2046 | P0 | pipeline | AI投标Phase4 投标知识库增强(S3→RAG) | ✅ |
| #1876 | P0 | backend | 商务48小时反馈机制+分级升级 | ✅ |
| #2368 | P0 | frontend | 菜单重组[5/8] 综合管理中心板块 | ✅ |
...
| #1459 | P0 | backend | 销售记录[10/16] 记录中心统一数据模型+多维关联API | ✅ |
