...
|------|-------|------|--------|------|--------|
| kimi1 | #1496 | backend | P2 | NBO行动推荐生成 — Today's Top 3行动 | 62% 🔥（52%→62%大幅进展） |
| kimi2 | #1497 | backend | P2 | NBO评分引擎 — 项目适配度×意图×赢率综合评分 | 48% 🔥 |
| kimi3 | #1538 | budget | P2 | D3造价回填接口 — D3设计完成后自动写入设备科目预算 | 49% ⚠️（66%→49%回退） |
| kimi4 | #1539 | budget | P2 | 历史基准自动积累 — 项目关闭时自动更新成本基准库 | 43% ⚠️（52%→43%回退） |
| kimi5 | #1590 | budget | P2 | 项目成本复盘报告自动生成 | 49% 🔥 |

> **5 CC活跃，池子已满**；kimi1大幅进展52%→62%；kimi3回退66%→49%；kimi4回退52%→43%；kimi2/kimi5持平；PR#4415/4421/4422/4423/4424/4431已merged；PR#4427/4425/4426 REVIEW_REQUIRED
