...
> 更新时间：2026-04-29 16:16（第36轮巡检，kimi1/#1942 PR#4338 merged Done，转#1955）
> ⚠️ needs-prototype冻结不出现在本表
> 排除：needs-prototype 标签、Master Issue、已派/已完成
> 当前运行：kimi1(#1955)/kimi2(#2217)，2CC活跃，2空位可补

| 序号 | Issue | 优先级 | 模块 | effort | 说明 | 启动 |
|------|-------|--------|------|--------|------|------|
| 199 | ~~#1955~~ | P1 | backend | medium | ~~方案引擎AI文案知识增强 — 已指派kimi1~~ | ~~✅~~ |
...
| kimi1 | #1955 | backend | P1 | 方案引擎AI文案知识增强（建议#199） | 编码中 |
