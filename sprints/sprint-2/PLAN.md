...
|------|-------|------|--------|------|--------|
| kimi1 | — | — | — | 空闲（#1973 PR#4403已合并，Issue自动关闭） | ✅ |
| kimi2 | — | — | — | 空闲（#2141 PR#4405已合并，Issue手动关闭） | ✅ |
| kimi3 | — | — | — | 空闲（#2162 PR#4404已合并） | ✅ |
| kimi4 | #4124 | fullstack | P1 | 国贸专属页 — 壳架构+5Tab容器+菜单入口 | PR #4376 新workflow触发（质量预检/冲突检测/视觉对比均pending） |
| kimi5 | — | — | — | 空闲（#3570 PR#4388手动合并，Issue手动关闭） | ✅ |
