...
| 2 | ~~#2737~~ | P1 | backend | ~~商战情报中台·分发[2/8] 企微交互式查询指令（kimi1已完成，PR#4394 merged）~~ | ✅ |
| 3 | #4124 | P1 | fullstack | 国贸专属页 — 壳架构+5Tab容器+菜单入口（kimi4已接） | 🔥 |
| 4 | ~~#3188~~ | P1 | fullstack | ~~回款资料[4/7] 企业信息库 — 万德常用信息维护+一键填充到回款表单（kimi2已完成，PR#4393手动合并）~~ | ✅ |
...
| 9 | ~~#1974~~ | P1 | pipeline | ~~方案引擎DB设计 — 素材库3张表（kimi1已完成，PR#4396 merged）~~ | ✅ |
...
|------|-------|------|--------|------|--------|
| kimi1 | — | — | — | 空闲（PR#4403已重开，CI重新触发中：冲突检测+质量预检pending） | — |
| kimi2 | #2141 | backend | P1 | 素材批量迁移工具 — S3/NAS/PPT拆页+AI自动打标签 | PR #4405 质量预检✅ 后端单测pending |
| kimi3 | — | — | — | 空闲（#2162 PR#4404已合并） | ✅ |
| kimi4 | #4124 | fullstack | P1 | 国贸专属页 — 壳架构+5Tab容器+菜单入口 | PR #4376 质量预检❌ 需修复 |
| kimi5 | #3570 | frontend | P1 | 关系网络Tab组件测试与截图验证（#3545-followup） | PR #4388 质量预检❌ 需修复 |
