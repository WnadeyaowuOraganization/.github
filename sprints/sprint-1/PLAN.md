...
## 指派建议（最近20个）
> 🔄 **更新** 2026-04-08 09:10 UTC | #1504 Done；#1756/#1726/#1508 已IP移除；补入2×P0新项

| Issue | 优先 | 模块 | 内容 | 启动 |
|-------|------|------|------|------|
| #1863 | P0 | frontend | [产品平台][P0] D3 Web产品目录浏览器 — 42品类在线浏览+3D预览 | ✅ |
| #1867 | P0 | pipeline | [D3-v2.0][P0] D3 AI知识体系构建 — 动态自动更新 | ✅ |
...
> 更新：2026-04-08 09:03 UTC | 满槽15/15 | kimi11(#2112✅PR#3415)+kimi14(#1872✅PR#3416)→Done→重派#2009/#2012；kimi4即将PR

| 指派目录 | Issue | Tier | 模块 | 内容 | 进度 |
|------|-------|------|------|------|------|
| kimi1 | #2399 | T1 | pipeline | [矿场-Phase3][2/12] 赢率预测模型训练Pipeline | 38% |
| kimi2 | #1492 | T1 | backend | [矿场-Phase4][14/17] 跟进超时提醒 | 编译✅即将PR |
| kimi3 | #2253 | T1 | frontend | [矿场增强][18/23] 企微H5矿场页面 | 30% |
| kimi4 | #2261 | T2 | frontend | [预算模板P0] 模板库管理页面 | 已注入PR创建 |
| kimi5 | #2241 | T1 | frontend | [矿场-Phase2][7/16] 项目详情关系地图 | 35% |
| kimi6 | #1504 | T1 | backend | [矿场-Phase3][1/12] 赢率预测特征工程 | 迁移修复23% |
| kimi7 | #2078 | T1 | backend | [问题发现-P1] 原因诊断API | 52% |
| kimi8 | #1508 | T1 | backend | [矿场-Phase2][8/16] 决策链联系人角色标签 | 23% |
| kimi9 | #2403 | T1 | pipeline | [矿场-Phase2][2/16] 企业工商数据采集 | 21% |
| kimi10 | #2228 | T1 | frontend | [矿场-Phase4][13/17] 管理看板-团队活动量 | 29% |
| kimi11 | #2009 | T1 | backend | [项目中心Phase7] 项目全景API | 启动中 |
| kimi12 | #1756 | T1 | frontend | [代理商工作台] 前端看板+列表视图 | 25% |
| kimi13 | #1766 | T1 | frontend | [代理商工作台] 前端管线+五阶段看板 | 38% |
| kimi14 | #2012 | T1 | backend | [项目中心Phase4] 跨部门任务Service | 启动中 |
| kimi15 | #1726 | T1 | frontend | [代理商工作台] 代理商管理页面 | 29% |
