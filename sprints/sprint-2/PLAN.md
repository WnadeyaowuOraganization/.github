...
| # | Issue | 优先级 | 模块 | 说明 | 启动 |
|---|-------|--------|------|------|------|
| 1 | ~~#2656~~ | P1 | pipeline | 品牌中心·内容自动化 [4/5] — 文章AI初稿生成+图文排版+审批推送 | ~~✅ 已指派 kimi4~~ |
...
| 7 | ~~#2707~~ | P2 | backend | 商战情报中台·客户雷达 [2/10] — ICP自动评分引擎 | ~~✅ 已指派 kimi2~~ |
| 8 | ~~#2708~~ | P2 | pipeline | 商战情报中台·客户雷达 [3/10] — 多源意图信号采集管线 | ~~✅ 已指派 kimi7~~ |
| 9 | ~~#2709~~ | P2 | fullstack | 商战情报中台·客户雷达 [4/10] — 客户购买阶段预测 | ~~✅ 已指派 kimi1~~ |
| 10 | ~~#2711~~ | P2 | fullstack | 商战情报中台·客户雷达 [6/10] — 客户雷达实时看板 | ~~✅ 已指派 kimi8~~ |
...
| 43 | ~~#3197~~ | P2 | backend | 计划管理REST API·Controller层 [5/10] | ~~✅ 已指派 kimi1~~ |
...
| #2496 | ❌ 依赖缺失（#1321/#1322 在 wande-play 不存在） | Todo（阻塞） |
...
| kimi3 | ~~#2118~~ | fullstack | medium | ~~Done~~ | [执行管理] AI BOM 智能推荐 — PR #4638 MERGED ✅ |
...
| kimi6 | ~~#2143~~ | fullstack | medium | ~~Done~~ | [品牌中心] AI内容建议 — PR #4645 MERGED ✅ |
...
| kimi7 | ~~#3104~~ | fullstack | medium | ~~Done~~ | PI形式发票生成+PDF导出 — PR #4718 MERGED ✅ |
| kimi7 | ~~#4721~~ | fullstack | medium | ~~Done~~ | 回款计划与逾期预警管理 — PR #4746 MERGED ✅ |
| kimi7 | #4747 | fullstack | medium | CC工作中 | 客户资产与净值评估管理 — 资产CRUD+净值计算+排行（新建） |
...
| kimi2 | ~~#2718~~ | fullstack | medium | ~~Done~~ | 商战情报·动态销售战斗卡引擎 — PR #4714 MERGED ✅ |
| kimi2 | #4720 | fullstack | medium | CC工作中 | 客户分级自动评定与管理 — 评分规则+等级分布看板（新建） |
...
| kimi3 | ~~#4712~~ | fullstack | medium | ~~Done~~ | 销售目标进度实时看板 — PR #4724 MERGED ✅ |
| kimi3 | #4725 | fullstack | medium | CC工作中 | 客户联系人批量导入与去重 — Excel/CSV+去重预览（新建） |
...
| kimi4 | ~~#2728~~ | backend | medium | ~~Done~~ | 商战情报·AI洞察自动生成引擎 — PR #4689 MERGED ✅ |
...
| kimi8 | ~~#4745~~ | fullstack | medium | ~~Done~~ | 客户回访计划与跟进提醒 — PR #4753 MERGED ✅ |
| kimi8 | #4756 | fullstack | medium | CC工作中 | 客户生命周期阶段自动化管理 — 阶段流转+停滞检测+看板（新建） |
...
| kimi3 | #2649 | #4644 | ✅ merged | LinkedIn自动投放 PR |
| kimi6 | #2143 | #4645 | ✅ merged | 品牌中心AI内容建议 PR |
...
| kimi2 | #2717 | #4652 | ✅ merged | AI事实卡片自动更新档案 MERGED |
| kimi3 | #2714 | #4653 | ✅ merged | 客户流失预警模型 MERGED |
| kimi4 | #2489 | #4654 | 🔄 CI中 | 批量渲染引擎 PR |
| kimi6 | #2715 | #4655 | 🔄 CI中 | ABM目标客户清单 PR |
| kimi8 | #2711 | #4651 | ✅ merged | 客户雷达实时看板 MERGED |
