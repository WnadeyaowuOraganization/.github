...
> 更新时间：2026-05-01（排程经理第293轮，kimi1-kimi3/kimi5空闲，4个CC待指派）
> ⚠️ needs-prototype冻结、Master Issue不出现在本表
> 注意：本表与GitHub Issue编号一致，无需转换

| # | Issue | 优先级 | 模块 | 说明 | 启动 |
|---|-------|--------|------|------|------|
| 1 | #2163 | P1 | backend | 素材库API+RBAC权限管理 — 方案素材库模块基础 | ✅ |
| 2 | #2126 | P1 | fullstack | 经销商发现 — 修正版种子数据+方法论后端 | ✅ |
| 3 | #2031 | P1 | backend | 色卡材料Phase5 — 非标色卡/材料使用审批流程 | ✅ |
| 4 | #4124 | P1 | fullstack | 国贸专属页 — 壳架构+5Tab容器+菜单入口（kimi4已接） | 🔥 |
| 5 | ~~#2747~~ | P1 | backend | ~~客户生命周期[4/12] 客户满意度回访提醒（kimi1已完成，PR#4391 merged）~~ | ✅ |
