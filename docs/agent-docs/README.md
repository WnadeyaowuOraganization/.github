...
│   ├── db-schema.md               ← 数据库变更管理+Flyway增量SQL流程
...
| [db-schema.md](/home/ubuntu/projects/.github/docs/agent-docs/share/db-schema.md) | 数据库列名规范、新表7个强制列(tenant_id等)、BaseEntity字段映射 |
