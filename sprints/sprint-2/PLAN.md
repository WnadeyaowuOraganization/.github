...
> 更新时间：2026-05-02（排程经理第400轮，5 CC活跃满负荷运行；kimi3+5%→68%、kimi4/compact→46%；PR#4415/4421/4422/4423/4424已merged）
...
|------|-------|------|--------|------|--------|
| kimi1 | #1496 | backend | P2 | NBO行动推荐生成 — Today's Top 3行动 | 26% 🔥（启动后43min） |
| kimi2 | #1497 | backend | P2 | NBO评分引擎 — 项目适配度×意图×赢率综合评分 | 16% 🔥（启动后43min） |
| kimi3 | #1538 | budget | P2 | D3造价回填接口 — D3设计完成后自动写入设备科目预算 | 68% 🔥（启动后43min） |
| kimi4 | #1539 | budget | P2 | 历史基准自动积累 — 项目关闭时自动更新成本基准库 | 46% 🔥（启动后43min） |
| kimi5 | #1590 | budget | P2 | 项目成本复盘报告自动生成 | 53% 🔥（启动后43min） |

> **5 CC活跃，池子已满**；kimi1 26%（持平）、kimi2 16%（持平）、kimi3 68%（+5%）、kimi4 46%（-9%，可能/compact）、kimi5 53%（持平）；全部正常工作中；PR#4415/4421/4422/4423/4424已merged
