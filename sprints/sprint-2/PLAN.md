...
> 更新时间：2026-04-28 10:10（第14轮刷新，后备design-ai 4条）
> ⚠️ needs-prototype冻结（共15个）不出现在本表
> 排除：needs-prototype 标签、Master Issue、已派/已完成

| 序号 | Issue | 优先级 | 模块 | effort | 说明 | 启动 |
|------|-------|--------|------|--------|------|------|
| 143 | #1834 | P1 | design-ai | high | AI环境自动填充 — 白模/实景→AI补树木/建筑/道路/人物/天空 | ✅ |
| 144 | #1835 | P1 | design-ai | medium | 环境模板库 — 10+预制场景(城市公园/社区/学校等)+一键套用 | ✅ |
| 145 | #1836 | P1 | design-ai | high | 受力计算+基础设计引擎 — 多国标准载荷组合+最优基础方案 | ✅ |
| 146 | #1849 | P2 | design-ai | medium | 意图路由API — 用户输入→自动分发到对应设计子模块 [1/30] | ✅ |
...
|------|-------|------|--------|------|--------|
| kimi1 | #1834 | design-ai | P1 | AI环境自动填充-白模/实景→AI补全（建议#143） | 编码中 |
| kimi2 | #1835 | design-ai | P1 | 环境模板库-10+预制场景（建议#144） | 编码中 |

**2/2 并发在线。排程经理刷新建议表#143-#146（4条design-ai）。**
