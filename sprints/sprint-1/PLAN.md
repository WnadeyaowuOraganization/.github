...
| kimi1 | #3117 | P1 | fullstack | [经销商发现] 经销商-甲方客户关系图谱（可视化关联关系）| 06:00 PR交付中（rebase完成，e2e spec重建） |
...
| kimi2 | #2417 | P1 | pipeline | [经销商发现-2/4] 竞品官网经销商网络采集脚本 | 05:55 启动 |
...
| kimi3 | #3722 | P1 | backend | 执行管理v2.0 [17/22] 变更管理API（记录+影响分析+审批） | 06:00 PR body准备中+pr-body-lint |
...
| kimi4 | #3725 | P0 | backend | 执行管理v2.0 [20/22] 验收管理API（5级验收+检查项） | 06:00 JUnit单测运行中（Maven test fix已注入） |
