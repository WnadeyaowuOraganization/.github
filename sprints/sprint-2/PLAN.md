...
> 更新时间：2026-04-29 03:12（排程经理第2轮自动巡检）
> ⚠️ needs-prototype冻结不出现在本表
> 排除：needs-prototype 标签、Master Issue、已派/已完成
> 当前运行：kimi1(#1930)/kimi2(#1932)/kimi4(#1902)，kimi3(#1928)超时309分钟需释放
...
| kimi3 | #1928 | backend | P1 | D3端到端验证 | 超时309分钟需释放 |
| kimi5 | 空闲 | - | - | - | 等待Issue |
| kimi6 | 空闲 | - | - | - | 等待Issue |
| kimi7 | 空闲 | - | - | - | 等待Issue |
| kimi8 | 空闲 | - | - | - | 等待Issue |

**3/8 并发运行中，4个CC空闲，kimi3超时需释放。**
