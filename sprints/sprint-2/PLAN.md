...
| # | Issue | 优先级 | 模块 | 说明 | 启动 |
|---|-------|--------|------|------|------|
| 1 | #3203 | P1 | backend | BOM变更→计划联动引擎 — 变更事件驱动计划自动调整 [11/11] | ✅ |
| 2 | #3202 | P1 | fullstack | 管理层计划仪表盘 — 多项目汇总+健康度评分 [10/10] | ✅ |
| 3 | #3201 | P1 | frontend | 供应商排程管理页面 — 三段式+日历排程 [9/10] | ✅ |
| 4 | #2657 | P1 | fullstack | 品牌中心·内容自动化 — 内容日历+海报/文章审批工作台+发布管理 [5/5] | ✅ |
| 5 | #2644 | P1 | fullstack | 品牌中心·员工代言 — 内容池管理+员工分享看板+H5分享页 [2/2] | ✅ |
