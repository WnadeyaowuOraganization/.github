...
| # | Issue | 优先级 | 模块 | 说明 | 启动 |
|---|-------|--------|------|------|------|
| 1 | #3200 | P1 | backend | 计划变更管理 — 版本对比+影响分析+审批流（project-plan [8/10]） | ✅ |
...
| 7 | #2641 | P1 | frontend | 品牌中心·视频裂变 — 视频裂变工作台+素材包审批页面 [2/3] | ✅ |
| 8 | #2645 | P1 | pipeline | 品牌中心·舆情监控 — 品牌舆情采集+情感分析+告警Pipeline [1/2] | ✅ |
