...
| kimi2 | #3461 | P0 | fullstack | [运行中] Tier-6: 耀总驾驶舱 v1.0 — 8 大区块（#3519 PR#3675 merged 23:01 后改派） | `docs/design/耀总驾驶舱/详细设计.md` | high |
...
| — | #3548 | P1 | fullstack | Tier-4: CRM-13 公司通讯录 — 全员联系人+部门树 | `docs/design/crm-商务中心/详细设计.md` | medium |
