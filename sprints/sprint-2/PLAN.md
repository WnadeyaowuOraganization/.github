...
|------|-------|------|--------|------|--------|
| kimi2 | #2756 | backend | P1 | 客户生命周期-通知规则管理API | PR#4241 CI中 |
| kimi7 | #2271 | backend | P1 | D3材质标注面板-构件选中+色块+3D预览 | E2E测试中 |
| kimi5 | #2268 | backend | P1 | D3材质-批量智能标注+模板+配色方案 | 刚启动 |
| kimi4 | #2264 | backend | P1 | D3 Web材料熟悉度-知识卡+小测验 | 刚启动 |

**暂停（等空位恢复）：** kimi1/#2265, kimi6/#2712
...
| kimi2 | #2756 | #4241 | ⏳ CI中 | MERGEABLE，冲突已解决 |
