...
| 文档 | 内容 | 何时读取 |
|------|------|---------|
| [docs/architecture.md](docs/architecture.md) | 项目概述、技术栈、关键技术点、构建命令 | 首次接触项目时 |
| [docs/conventions.md](docs/conventions.md) | Entity/Mapper/Service/Controller编码模板、@DS注解规范 | 写代码时 |
| [docs/db-schema.md](docs/db-schema.md) | 数据库变更管理、增量SQL流程、列名规范 | 涉及数据库变更时 |
| [docs/testing.md](docs/testing.md) | TDD流程、单元测试、API集成测试、质量门禁 | **每次开始新Issue时必读** |
| [docs/workflow.md](docs/workflow.md) | TDD三阶段开发流程、Issue读取、提交规范 | 每次开始新Issue时 |
