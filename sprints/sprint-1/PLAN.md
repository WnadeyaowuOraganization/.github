...
> 最后更新：2026-04-08 19:20 UTC（巡检：研发经理已批量指派9个CC；#3458 Jump→In Progress(kimi3)；容量15/15满槽；kimi1/13/14占CLOSED将释放3槽）
...
## 指派建议（最近20个）
> 🔄 **更新：2026-04-08 19:20 UTC | 容量15/15满槽 | kimi1/13/14占CLOSED释放3槽 | 以下为下一批候选**

| Issue | 优先 | 模块 | 内容 | 启动 |
|-------|------|------|------|------|
| ~~#3458~~ | P0 | fullstack | ~~全球项目矿场v3.0~~ | kimi3 运行中 |
| ~~#2301~~ | P0 | frontend | ~~整改工单工人端H5~~ | kimi17 运行中 |
| ~~#2302~~ | P0 | frontend | ~~整改工单详情页~~ | kimi18 运行中 |
| ~~#2303~~ | P0 | frontend | ~~整改工单列表+看板~~ | kimi19 运行中 |
| ~~#2008~~ | P0 | backend | ~~资金闭环报价成本模型API~~ | kimi5 运行中 |
| ~~#2122~~ | P0 | backend | ~~AI回款风险预警~~ | kimi7 运行中 |
| ~~#1919~~ | P0 | frontend | ~~D3-Web 电池包目录~~ | kimi9 运行中 |
| ~~#1918~~ | P0 | frontend | ~~D3-Web 参数配置器~~ | kimi11 运行中 |
| ~~#1519~~ | P1 | backend | ~~业务看板API~~ | kimi12 运行中 |
| #1921 | P0 | design-ai | [D3-v2.0][紧急] D3Plugin.gha SDK版本降级 — 兼容Rhino 8.0+ | ✅ 待槽位 |
| #1938 | P0 | design-ai | [D3-v2.0][Phase1-1/4] 电池包制造级管件精度升级 | ✅ 待槽位 |
| #1917 | P0 | frontend | [D3-Web] 设计师自助上传 — .gh文件上传+参数自动识别 | ✅ 待槽位 |
| #1628 | P1 | backend | [整改工单][Phase29] AI视觉审查Service — Qwen2.5-VL | ✅ #1630解锁 |
| #1518 | P1 | backend | [业务运营中心][7/8] 业务数据仪表盘 — 业务KPI统计 | ✅ #1520解锁 |
| #1746 | P1 | frontend | [质保售后] 售后工单管理主页面 — 看板+列表+筛选 | ✅ #2109解锁 |
| #1742 | P1 | frontend | [质保] 质保台账管理页面 — 台账+到期预警+设备明细 | ✅ #2110解锁 |
| #2459 | P1 | backend | [合同管理] 合同审批API — AI辅助快速审批流程 | ✅ 独立 |
| #2458 | P1 | backend | [合同管理] AI条款对比引擎 — 我方vs甲方逐条Diff | ✅ 独立 |
| #2479 | P1 | backend | [D3-AI][3/3] 账号池AI渲染集成 — 多平台统一调度 | ✅ #2477解锁 |
