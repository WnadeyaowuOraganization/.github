...
> 更新时间：2026-05-02（排程经理第374轮，5 CC满载运转；kimi2切#1485(28%)；kimi4切#1495(26%)；kimi1 47%；kimi3 60%；kimi5 50%；PR#4415仍APPROVED待合并）
...
|------|-------|------|--------|------|--------|
| kimi1 | #1490 | backend | P2 | 个人周报/团队月报自动生成+推送 | 47% 🔥（593min） |
| kimi2 | #1485 | backend | — | 新会话（#1665→#1485切换） | 28% 🔥 |
| kimi3 | #1760 | frontend | P2 | 经销模式前端适配 — 项目详情+经销商结算对账 | 60% 🔥（PR#4418 REVIEW_REQUIRED） |
| kimi4 | #1495 | backend | — | 新会话（#1659→#1495切换） | 26% 🔥 |
| kimi5 | #1948 | backend | — | 新CC | 50% 🔥 |

> 5 CC满载运转；kimi2切#1485(28%)；kimi4切#1495(26%)；kimi1 47%；kimi3 60%；kimi5 50%；PR#4415仍APPROVED待合并
