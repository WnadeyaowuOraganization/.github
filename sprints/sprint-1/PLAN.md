...
## 指派建议（最近20个）
> 🔄 **更新** 2026-04-08 12:35 UTC | #2261/#2465/#2406/#1510/#1511/#2384/#2095 看板修正Done✓；#2096 Plan→Todo(#2098解锁)；kimi4/7 post-task完成后空闲

| Issue | 优先 | 模块 | 内容 | 启动 |
|-------|------|------|------|------|
| #2096 | P1 | backend | [执行管理] 整改工单管理API — 责任人指派+复验流程（#2098 Done解锁） | ✅ |
...
| #2361 | P1 | frontend | [项目中心Phase10] 项目任务面板 | kimi13 IP |
| #2254 | P1 | frontend | [矿场增强][10/23] 可赢性评分展示+Go/No-Go | kimi3 IP |
...
> 更新：2026-04-08 12:19 UTC | kimi5→#2260(frontend)，kimi13→#2361(frontend)；看板GraphQL限制待13:08重置补更新(#2359/#2261/#2465/#2406/#1510/#1511)；满槽15/15
...
| kimi4 | #2261 | T2 | frontend | [预算模板P0] 模板库管理页面 | 等待PR合并 |
| kimi5 | #2260 | T1 | frontend | [预算模板11/12] 项目预算编制增强 | 启动中 |
| kimi6 | #2120 | T1 | backend | [执行管理] AI项目进度智能跟踪 | 运行中 |
| kimi7 | #2465 | T1 | backend | [执行管理] 生产进度/质检/发货/安装API | 注入继续中 |
| kimi8 | #2237 | T1 | backend | [矿场-Phase3][4/12] 项目列表赢率列排序 | 运行中 |
| kimi9 | #1464 | T1 | backend | [销售记录体系][2/9] 里程碑门控配置 | 运行中 |
| kimi10 | #1463 | T1 | backend | [销售记录体系][3/9] 智能提醒频率引擎 | 运行中 |
| kimi11 | #2240 | T1 | frontend | [矿场-Phase2][9/16] 决策链可视化组件 | 运行中 |
| kimi12 | #1828 | T1 | frontend | [提成绩效] 提成规则配置页面 | 运行中 |
| kimi13 | #2361 | T1 | frontend | [项目中心Phase10] 项目任务面板 | 启动中 |
