...
> 更新于 2026-04-20（kimi19/#3654 Done，1槽空）
> 当前运行：kimi1/#3385 + kimi3/#3651 + kimi4/#3383 + kimi6/#3384（4/5）

| 建议kimi | Issue | 优先 | 模块 | 内容 | 备注 |
|---------|-------|------|------|------|------|
| kimi19 | #3388 | P1 | plm | PLM[11/20] 超级BOM规则引擎（N选1/数量型/参数化+校验API） | 前置#3380✅#3378✅均已Done，可立即启动 |
...
| kimi19 | #3388 | plm | PLM[11/20] 超级BOM规则引擎 | 待派 |
