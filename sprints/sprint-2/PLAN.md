...
| 6 | #2637 | P1 | frontend | 品牌中心·数字人 — AI视频生成工作台+审批队列 [5/7] | ✅ |
| 7 | #2660 | P1 | frontend | 色卡配色器 — 交互式配色面板+实时预览 [2/4] | ✅ |
| 8 | #2740 | P1 | frontend | 商战情报中台·分发 — 移动端情报快览小程序 [5/8] | ✅ |
| 9 | #3116 | P1 | pipeline | 经销商发现 — 评分模型增加「专注度检验」维度 | ✅ |
| 10 | #2495 | P1 | pipeline | 竞品情报Phase4 — T2级14家扩展采集 | ✅ |
| 11 | #2413 | P2 | pipeline | 竞品出口客户反向采集 — 凯奇/奇特乐/永浪海外买家（海外客户发现 [2/3]） | ✅ |
| 12 | #2451 | P2 | backend | 竞品中标项目名称分词 → 补充keyword_pool搜索盲区（[5/38]） | ✅ |
| 13 | #2663 | P2 | backend | 库存联通 — 仓库维度表+sample_inventory增加warehouse_id [1/3] | ✅ |
| 14 | #2664 | P2 | backend | 库存联通 — 多仓库库存查询+智能调拨单API [2/3] | ✅ |
