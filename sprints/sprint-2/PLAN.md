...
> 更新时间：2026-04-28 11:40（第15轮刷新，D3-parametric P0/P1 批量释放）
> ⚠️ needs-prototype冻结不出现在本表
> 排除：needs-prototype 标签、Master Issue、已派/已完成

| 序号 | Issue | 优先级 | 模块 | effort | 说明 | 启动 |
|------|-------|--------|------|--------|------|------|
| 147 | #1835 | P1 | design-ai | medium | 环境模板库 — kimi2 运行中 | ✅ |
| 148 | #1836 | P1 | design-ai | high | 受力计算+基础设计引擎 — kimi1 运行中 | ✅ |
| 149 | #1910 | P0 | backend | high | 万德知识库构建 — 标准参数+工艺规范→AI System Prompt | ✅ |
| 150 | #1909 | P0 | backend | high | 电池包几何生成第一批 — 立柱+平台+螺旋楼梯+荡桥+滚塑滑桶+横梁 | ✅ |
| 151 | #1937 | P0 | fullstack | high | 扣件螺栓精确定位 — 孔位坐标+扭矩标注+连接方式(Phase1-2/4) | ✅ |
| 152 | #1933 | P0 | backend | high | 螺旋滑梯电池包 — 邵鹏参数+塑料滑桶(Phase2-2/6) | ⏳前置#1909 |
| 153 | #1932 | P0 | backend | high | 秋千/吊环电池包 — 独立件+A型架+运动轨迹安全区(Phase2-3/6) | ⏳前置#1909 |
| 154 | #1907 | P0 | backend | high | 滚塑滑桶专项 — φ800模具+分节规则+透明桶+三标准合规 | ⏳前置#1909 |
| 155 | #1930 | P0 | fullstack | high | 攀爬网/爬梯电池包 — 垂直/倾斜/绳网3种形态(Phase2-5/6) | ⏳前置#1909 |
| 156 | #1929 | P0 | frontend | medium | GH插件.gha安装包 — 双击安装+工具栏分类+搜索(Phase2-6/6) | ⏳前置#1909 |
| 157 | #1911 | P0 | backend | high | AI电池包开发助手 — 中文→GH Python脚本生成(G7e Qwen3.5) | ✅ |
| 158 | #1898 | P0 | backend | high | 发货防错系统 — QR扫码装箱验证+数字装箱单+错漏发追溯 | ✅ |
| 159 | #1850 | P1 | design-ai | high | Agent自学习闭环+效果度量 — 纠正记录/失败模式/模板积累 | ✅ |
| 160 | #1851 | P1 | design-ai | medium | 审核与自动部署流程 — 邵鹏提交→吴耀审核→一键部署 | ✅ |
| 161 | #1900 | P1 | backend | high | 采购下料单自动生成 — BOM→分类采购单+钢管下料优化 | ✅ |
...
|------|-------|------|--------|------|--------|
| kimi1 | #1836 | design-ai | P1 | 受力计算+基础设计引擎（建议#148） | 编码中 |
| kimi2 | #1910 | backend | P0 | 万德知识库构建-标准参数+AI Prompt（建议#149） | 编码中 |
