...
| kimi4  | #3187 | finance | 全阶段文件缺失预警 — 三级升级推送+企微/站内双通道+阶段门控 | PR#3938冲突修复中 |
...
| kimi19 | #3184 | project360 | 文档访问日志+统计 — 谁看了什么文件·下载追踪 | 进行中 |
| kimi6  | #1687 | approval | 企微审批通知+消息推送+逾期提醒 | 进行中 |
