...
| kimi5 | #1467 | P1 | backend | [商务赋能知识中台][25/28] 安装说明自动生成 | 06:52 启动 |
...
| kimi1 | #3726 | P2 | backend | 执行管理v2.0 [21/22] 质保+售后工单+设备档案API | 06:10 启动 |
...
| kimi2 | #1736 | P1 | frontend | 执行管理 验收列表+阶段配置+发起验收页面（配对#3725） | PR#3766⏳ 等待CI merge |
...
| kimi4 | #1531 | P1 | backend | [矿场增强] 可赢性评分模型(Win Probability) — 4维度综合赢率计算 | 06:52 启动 |
