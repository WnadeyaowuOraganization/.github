...
| kimi5 | #3588 | P2 | frontend | 产品门户 [9/10] H5移动端适配（产品目录/详情/备件三页） PR#3753⏳ CI质量预检修复中 | 05:33 恢复 |
...
| kimi1 | #3117 | P1 | fullstack | [经销商发现] 经销商-甲方客户关系图谱（可视化关联关系）| 05:29 恢复（后端代码已写，需修复Controller+前端） |
...
| kimi2 | #3133 | P0 | backend | [审批引擎] 审批节点回退增强（回退到指定节点+直达模式） | 05:31 恢复（Phase1+2 代码已写但包路径需修正，继续Phase3） |
...
| kimi3 | #3722 | P1 | backend | 执行管理v2.0 [17/22] 变更管理API（记录+影响分析+审批） | 05:29 恢复（代码已写，需修复Controller 404+commit+PR） |
...
| kimi4 | #3725 | P0 | backend | 执行管理v2.0 [20/22] 验收管理API（5级验收+检查项） | 05:29 恢复（代码已写，需修复Controller 404+commit+PR） |
