...
> 最后更新：2026-04-08 14:44 UTC（pg-test 20/20 全部DONE，恢复业务指派；看板状态批量修正）
...
## 指派建议（最近20个）
> 🔄 **更新：2026-04-08 17:15 UTC | 【P0插队】项目挖掘改版运行中 | 容量 16/15 超限 1 | 清理过期锁 kimi2/4/13 | 高进度监控 kimi8#1564 74%、kimi12#1858 67%**

| Issue | 优先 | 模块 | 内容 | 启动 |
|-------|------|------|------|------|
| #3449 | P0 | frontend | [项目挖掘改版][1/8] 详情抽屉清理+修复Drawer泄漏 | kimi10 运行中 |
| #3450 | P0 | fullstack | [项目挖掘改版][2/8] 配合单位联系方式显示 | ✅ |
| #3451 | P0 | fullstack | [项目挖掘改版][3/8] 多信源链接展示 | ✅ |
| #3452 | P0 | fullstack | [项目挖掘改版][4/8] 项目分配功能 | kimi16 运行中 |
| #3453 | P0 | frontend | [项目挖掘改版][5/8] 统一表格视图+投标截止倒计时 | ✅ |
| #3454 | P0 | fullstack | [项目挖掘改版][6/8] 竞对动态Tab增强 | ✅ |
| #3455 | P0 | fullstack | [项目挖掘改版][7/8] 项目研判卡 | ✅ |
| #3456 | P0 | frontend | [项目挖掘改版][8/8] 更新设计文档 | ✅ |
| #1993 | P1 | backend | [项目中心Phase16][16/22] 健康度评分引擎 — 5维度算法+每日快照 | ✅ |
| #2479 | P1 | backend | [D3-AI][3/3] 账号池AI渲染集成 — 独立 | ✅ |
| #2051 | P1 | frontend | D3-L4安装图自动化 — 独立 | ✅ |
| #1796 | P1 | frontend | [合同管理] 合同审批流程页面 — AI辅助快速审批 | ✅ |
| #1928 | P1 | pipeline | [D3-v2.0][Phase3-1/3] v2.0电池包→图纸输出桥接 | ✅ |
...
| #2260 | P1 | budget | [预算模板11/12] 项目预算编制增强 | kimi5 IP |
| ~~#2254~~ | P1 | frontend | ~~[矿场增强][10/23] 可赢性评分展示+Go/No-Go~~ | ✅ PR#3424 Done |
| #2096 | P1 | backend | [执行管理] 整改工单管理API — 责任人指派+复验流程 | kimi7 IP |
| ~~#2120~~ | P1 | backend | ~~[执行管理] AI项目进度智能跟踪~~ | ✅ PR#3445 |
| #2237 | P1 | backend | [矿场-Phase3][4/12] 项目列表赢率列排序 | kimi8 IP |

---

# 以下内容由研发经理每次指派前维护

## 当前运行（4 常规 + 11 P0冲突修复 + 1新指派 = 16/15超限 1）

> 更新：2026-04-08 17:15 UTC | 容量 16/15 超限 1（#3449/#3452 新指派后）；清理 kimi2/4/13 过期锁；高进度监控：kimi8 74%、kimi12 67%、kimi6 68%

| 指派目录 | Issue | Tier | 模块 | 内容 | 进度 |
|------|-------|------|------|------|------|
| kimi1 | #3288 | P0 | frontend | [**冲突修复**] 验收队列前端 PR#3288 rebase | 17% |
| kimi2 | #2445 | P0 | pipeline | [**冲突修复**] 定向监控[12/38] PR#3305 rebase | 运行中 |
| kimi3 | #2851 | P0 | frontend | [**冲突修复**] 开发监控[7/7] PR#3288 rebase | 34% |
| kimi4 | #2051 | P1 | frontend | D3-L4安装图自动化 | 19% |
| kimi5 | #1756 | P0 | frontend | [**冲突修复**] 代理商工作台 PR#3424 rebase | 41% |
| kimi6 | #1531 | P0 | backend | [**冲突修复**] 可赢性评分模型 PR#3240 rebase | 62% |
| kimi6 | #2893 | P0 | fullstack | [**冲突修复**] Claude Office PR#3315 rebase | 68% |
| kimi7 | #1505 | P1 | backend | [矿场-Phase2][16/16] 阶段话术模板库 | 64% |
| kimi8 | #1564 | P0 | backend | [**冲突修复**] 企微打通 PR#3260 rebase | 74% ⏰即完成 |
| kimi9 | #2055 | P0 | backend | [**冲突修复**] D3参数化 PR#3274 rebase | 40% |
| kimi10 | #3449 | P0 | frontend | [项目挖掘改版][1/8] 详情抽屉清理+修复Drawer泄漏 | 21% |
| kimi11 | #1520 | P1 | backend | [业务运营中心][3/8] CRM操作面板 | 62% |
| kimi12 | #1858 | P1 | backend | [产品平台][P1] 方案版本对比 | 67% |
| kimi14 | #2589 | P0 | backend | [**冲突修复**] execution执行管理 PR#3317 rebase | 20% |
| kimi15 | #1862 | P1 | backend | [产品平台][P1] 标准品报价引擎 | 28% |
