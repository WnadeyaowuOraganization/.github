...
> 更新时间：2026-04-28 00:10（第13轮刷新，从Plan队列释放24个P1到Todo）
> ⚠️ needs-prototype冻结（共15个）不出现在本表
> 排除：needs-prototype 标签、Master Issue、已派/已完成

| 序号 | Issue | 优先级 | 模块 | effort | 说明 | 启动 |
|------|-------|--------|------|--------|------|------|
| 122 | #1487 | P3 | backend | medium | 跨境客户资格评估 — 8维度评估表+评级计算 [5/10] | ✅ |
| 123 | #1704 | P1 | brand | medium | 品牌中心-项目案例库 CRUD API — 案例管理+推荐+全文搜索 | ✅ |
| 124 | #1727 | P1 | brand | medium | 品牌中心-项目案例库页面 — 瀑布流+案例详情+编辑 | ✅ |
| 125 | #1776 | P1 | brand | medium | 品牌中心-账号设置页面 — 7大平台OAuth绑定+状态指示 | ✅ |
| 126 | #1778 | P1 | brand | medium | 品牌中心-内容审批页面 — 审批列表+操作+记录 | ✅ |
| 127 | #1814 | P1 | brand | medium | 品牌中心-数据中心页面 — KPI面板+趋势图+排行榜 | ✅ |
| 128 | #1820 | P1 | brand | medium | 品牌中心-发布日历页面 — 月历/周历+内容排期+拖拽 | ✅ |
| 129 | #1670 | P1 | biz-enablement | medium | 经销报价单生成API — 批量选品+经销价+折扣+PDF [5/13] | ✅ |
| 130 | #1667 | P1 | biz-enablement | medium | AI产品参数翻译API — 中文→英文Spec自动翻译 [7/13] | ✅ |
| 131 | #1668 | P1 | biz-enablement | medium | 国贸文档打包API — 英文Spec+认证+多语言目录 [6/13] | ✅ |
| 132 | #1713 | P1 | biz-enablement | medium | 国贸文档打包页面 — 产品选择+语言+认证勾选+打包下载 [12/13] | ✅ |
| 133 | #1768 | P1 | frontend | medium | AI中枢-Web聊天气泡 — 右下角悬浮窗+Markdown+对话历史 | ✅ |
| 134 | #1774 | P1 | ai-assistant | medium | 方案引擎-PPT模板中心页面 — 按项目类型管理方案模板 | ✅ |
| 135 | #1784 | P1 | frontend | medium | 方案引擎-方案自动拼装+协同修改页面 [项目管理+任务面板] | ✅ |
| 136 | #1786 | P1 | frontend | medium | 方案引擎-技术参数智能查询页面 — 对话式+结构化+选型 | ✅ |
| 137 | #1788 | P1 | frontend | medium | AI内容生成工作台 — 投标方案/效果图/品牌素材/智能助写 | ✅ |
| 138 | #1793 | P1 | fullstack | medium | 方案素材库页面 + RBAC 权限管理 | ✅ |
| 139 | #1794 | P1 | frontend | medium | 导航-启用方案设计入口+图图功能导航 | ✅ |
| 140 | #1764 | P1 | frontend | medium | 经销商发现-修正版方法论前端展示 | ✅ |
| 141 | #1679 | P1 | backend | medium | AI生成-效果图生成 ComfyUI 工作流 | ✅ |
| 142 | #1680 | P1 | pipeline | medium | AI生成-体育设施风格 LoRA 训练 | ✅ |
...
|------|-------|------|--------|------|--------|
| kimi1 | #1679 | backend | P1 | AI生成-效果图生成ComfyUI工作流（建议#141） | 即将提PR |
| kimi2 | #1680 | pipeline | P1 | AI生成-体育设施风格LoRA训练（建议#142，最后1个） | 编码中 |

**2/2 并发在线。建议表#122-#142全部已派。**
